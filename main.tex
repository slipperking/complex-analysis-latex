...
It follows that the points \(\mqty(0\\0\\0)\), \(\mqty(x\\y\\1)\), and \(\mqty(x_1\\x_2\\1-x_3)\) are collinear in \(\mathbb{R}^3\). Under the linear transformation \(\mqty(\mqty{\imat{2}}&\mqty{\zmat{2}{1})\)
