...
Let \(f(z)\in \Aut\qty(\riemannsphere)\) such that \(f(\infty)=\infty\). It follows that \(f\) maps \(\mathbb{C}\) to \(\mathbb{C}\) bijectively and \(\Aut(\mathbb{C})\subset\Aut\qty(\riemannsphere)\). Let \(g(z)\in\Aut\qty(\riemannsphere
