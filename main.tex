...
\begin{definition}[Topological Space]
    A topological space \(X\), d\([Insert here]\) is a set equipped with a topology \([topology insert here]\), or a collection of sets that are to be considered open under 
\end{definition}
\begin{lemma}
