...
\[\frac{1}{2\pi}\sum_{n=-\infty}^\infty\int_0^{2\pi}\rho^{|n|}u\qty(e^{i\tau})e^{in(\theta-\tau)}\dd{\tau}=\frac{1}{2\pi}\int_0^{2\pi}u\qty(e^{i\tau})\sum_{n=-\infty}^\infty\rho^{|n|}e^{in(\theta-\tau)}\dd{\tau},\]
\begin{align*}
    ...
    &=1+2\Re\qty[\frac{\rho\exp[i(\theta-\tau)]-\rho^2}{1+\rho^2-2\rho\cos(\theta-\tau)}]\\
