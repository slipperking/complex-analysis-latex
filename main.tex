...
\begin{proof}
    ...
    \begin{align*}
        ...
        &= \varepsilon i \int_\alpha^\beta \qty(\frac{c_{-1}}{\varepsilon e^{i\theta}}+h(a + \varepsilon e^{i\theta}))e^{i\theta}\dd{\theta} \\
    ...
    \end{align*}
    As \(\varepsilon\to0\), \(\varphi(a+\varepsilon e^{i\theta})\to\varphi(a)\) uniformly in \(\theta\), so the second term vanishes:
    \[\lim_{\varepsilon \to 0} \varepsilon i \int_\alpha^\beta h(a + \varepsilon e^{i\theta}) e^{i\theta}\dd{\theta}=0.\]
    Therefore,
