...
\begin{proof}
    ...
    For the sake of contradiction, assume that \(\rho>\frac{1}{2}\). It follows that the arc \(S=\partial\mathbb{D}\cap D\qty(z_0,\frac{1}{2})\neq\emptyset\). Let \(\zeta\in S\) be arbitrary.
\end{proof}
