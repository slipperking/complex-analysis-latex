...
\begin{proof}
    \begin{figure}
        ...
        \begin{tikzpicture}[>=stealth,
            ...
            \node[anchor=south west] at ([shift={(-2pt, 24pt)}] M1) {\(M'_1\)};
            \node[anchor=north west] at ([yshift=-20pt] P1) {\(P'_1\)};
            \node[anchor=north east] at ([shift={(2pt, -24pt)}] Q1) {\(Q'_1\)};
            \node[anchor=south east] at ([yshift=20pt] N1) {\(N'_1\)};
