...
\begin{proof}
    ...
    \end{cases}.\]
    By the continuity of \(f\) on \(\partial D(0,R)\), it attains its maximum \(M\). For sufficiently large \(R\), \(\abs{\zeta-z}\) attains a positive minimum. Then the integrand is uniformly bounded. 
\end{proof}
