...
In the theory of partial differential equations, an important problem is to find the solution to Laplace's equation on a region that is equal to a given continuous function on the boundary. 
