...
Geometrically, the angle at \(z_0\) between two smooth curves passing \(z_0\) in \(U\) is preserved under \(f\). Consider any arbitrary curve \(\gamma(t)\in C^1([0,1])\) which passes \(z_0\) with image \(\sigma(t)\).
