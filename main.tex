...
\begin{proof}
    ...
    By the properties above, \begin{align*}
        \int_{f(U)}\dd{A}&=\frac{i}{2}\int_{f(U)}\dd{w}\wedge\dd{\overline{w}}\\
        &=\frac{i}{2}\int_{U}\dd{f(z)}\wedge\dd{\overline{f(z)}}\\
        &=\frac{i}{2}\int_{U}\paren{\pdv{f}{z}\ddz+\pdv{f}{\overline{z}}\dd{\overline{z}}}\wedge\paren{\pdv{f}{z}\ddz+\pdv{f}{\overline{z}}\dd{\overline{z}}}\\
    \end{align*}
\end{proof}
