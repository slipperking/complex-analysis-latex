...
One of the most profound results in complex analysis is the Residue Theorem. After Riemann and Weierstrass refined the understanding of analytic functions and the formal characterization of Jordan curves, its formulation
Let \(U\subseteq\mathbb{C}\) be open, \(a\in U\), and \(f:U\setminus\qty{a}\to \mathbb{C}\) be holomorphic. 
