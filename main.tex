...
Additionally by the proof of \autoref{dirichletproblemwithlaplaceequationsolution}, we have \[\lim_{\rho\to1^-}\sum_{n=-\infty}^\infty a_ne^{in\theta}\rho^{\abs{n}}=u\qty(e^{i\theta}).\]
Therefore, for any arbitrary continuous function on \(\partial\mathbb{D}\), its Fourier series is Abel summable.
