...
\end{theorem}
\begin{proof}
    \(\forall z_0\in U\), \(\forall z\in D\paren{z_0,\varepsilon}\), by \autoref{thm:cauchygoursatformula}, \[f(z)-f\paren{z_0}=\frac{1}{2\pi i}\int_{\partial D\paren{z_0,\varepsilon}}\paren{\frac{f(\zeta)}{\zeta-z}-\frac{f(\zeta)}{\zeta-z_0}}\ddzeta,\]
    and dividing by \(z-z_0\), it becomes \[\frac{f(z)-f\paren{z_0}}{z-z_0}=\frac{}\]
\end{proof}
\end{document}