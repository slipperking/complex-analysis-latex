...
\begin{proof}
    ...
    \end{gather*} Because $f\in C^1\left(\overline{U}\right)$, by \autoref{lemma:c1lipschitz}, \(\exists M\ge0\) that is finite such that \(\forall z_0,z_1\in\overline{U}\), \(\abs*{f\paren*{z_1}-f\paren*{z_0}}\le M\abs*{z_1-z_0}\).
