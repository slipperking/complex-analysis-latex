...
\begin{proof}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \node[left, xshift=-4pt, yshift=-1pt] at (C) {\(C\)};
    ...
    \end{align*} Thus, if the integral over every triangle in \(U\) vanishes, then \eqref{eq:cauchyintegraltheoremoversimplyconnectedset_statement} follows. Consider a triangle in \(U\) with boundary \(\Delta\). \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \path let
                ...
                \p4 = (BF)
            in
                node[shift={(5pt,-5pt)}] at (\x1, \y2) {\(\Delta_2\)}
                node[shift={(5pt,-5pt)}] at (\x3, \y4) {\(\Delta_1\)};
        \end{tikzpicture}
    ...
    Quadrisect the triangle bounded by \(\Delta\) into four triangles with boundaries \(\Delta_1,\Delta_2,\Delta_3,\Delta_4\) as in \autoref{fig:cauchyintegraltheoremoversimplyconnectedset_trianglequadrisection}.
