...
\begin{proof}
    ...
    By combining and rearranging, we obtain \[i\int_0^{2\pi}f(z+\varepsilon e^{it})\dd{t}=\int_U\frac{f(\zeta)\ddzeta}{\zeta-z}-\int_{U\setminus D(z,\varepsilon)}\pdv{f}{\overline{\zeta}}\cdot\frac{f(\zeta)}{\zeta-z}\dd{\overline{\zeta}}\wedge\ddzeta.\]
\end{proof}
\end{document}