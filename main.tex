...
\begin{proof}
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \draw[thin, |-|, line cap=round, shorten >=1pt, shorten <=1pt] (0,0) -- (3.0310889,1.75) node[midway, above] {\(R\)};;
            \draw[thin, |-|, line cap=round, shorten >=1pt, shorten <=1pt] (0,0) -- (0,2) node[midway, right] {\(r\)};
