...
\[\dd{\theta}=\frac{1-\frac{\abs{a}^2}{R^2}}{\paren{1-\frac{\overline{a}}{R}e^{i\tau}}^2}e^{i\tau}e^{-i\theta}\dd{\tau}=\dd{\theta}=\frac{1-\frac{\abs{a}^2}{R^2}}{\paren{1-\frac{\overline{a}}{R}e^{i\tau}}^2}\frac{1-\frac{\overline{a}}{R}e^{i\tau}}{1-\frac{a}{R}e^{-i\tau}}\dd{\tau}=\frac{R^2-\abs{a}^2}{\abs{R-\overline{a}e^{i\tau}}^2}\dd\tau.\]
Then,
\[\phi(z)=\frac{1}{2\pi}\int_0^{2\pi}\phi\qty(e^{i\tau})\frac{1-\abs{a}^2}{\abs{1-\overline{a}e^{i\tau}}^2}\dd{\tau}.\]
