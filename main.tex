...
\begin{theorem}[Green's Theorem]\label{theorem:realgreen}
    Let \(R\) be a positively oriented, multiply connected region in $\mathbb{R}^2$, and let \(\partial R\) be the oriented boundary of \(R\). For \(P(x,y),Q(x,y)\in C^1\left(\overline{R}\right)\),
