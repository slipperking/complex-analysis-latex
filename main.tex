...
\begin{proof}
    ...
    Let \(K\subset U\) be arbitrary and compact. Since \(\cbraces{f'_n(z)}\) is holomorphic, we can define a holomorphic sequence \(\varphi_n(z)=f_n(z)-f(z)\). By \autoref{crl:nthderivativeboundedsupremum}, \[\lim_{n\to\infty}\sup_{z\in K}\abs{\varphi'_n(z)}\leq c_n\sup_{z\in}\]
\end{proof}
