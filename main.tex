...
\begin{proof}
    ...
    Since \(z_0\in S\), the first condition is satisfied (nonemptiness). By the continuity of \(f\), \(S\) is closed in \(V\) (refer to the proof of \autoref{thm:identityaccumulationofzeros}). 
