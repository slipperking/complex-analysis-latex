...
Indeed, imagine that there was a holomorphic function with a locally minimum modulus at a zero. Then after a shift, the zero would disappear, which would not preserve the stability of zeros, which is guaranteed by \autoref{thm:zerosofashiftedholomorphicfunctionoverneighborhood}, which seems counterintuitive. As a matter of fact, a holomorphic function cannot attain a minimum or maximum modulus at a point (with respect to some open neighborhood of that extrema).
