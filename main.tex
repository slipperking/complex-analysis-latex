...
\begin{proof}
	...
	\end{align*}
	Let us evaluate the integral on \(\gamma_\varepsilon\) as \(\varepsilon\to 0\). Extend the semicircle to a full circle of radius \(\varepsilon\) centered at \(0\).
	\begin{align*}
		\ointclockwise_{\partial D(0,\varepsilon)}f(z)\ddz&=-2\pi i\residue_{z=0}f(z)=\int_{\gamma_\varepsilon}f(z)\ddz+\int_{\gamma_\varepsilon}f(-z)\dd(-z).
	\end{align*}
	...
	Hence, 
	\begin{align*}
		\int_{\gamma_\varepsilon}\frac{e^{iz}}{z}\dd&=-2\pi i-\int_{\gamma_\varepsilon}\frac{e^{-iz}}{-z}\dd(-z)
	\end{align*}
\end{proof}
