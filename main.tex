...
\begin{proof}
    ...
    Similarly, \(a_1=0\). We recursively obtain that \(a_0,a_1,\ldots=0.\) Then \(f\equiv0\) over \(D\paren{z_0,\varepsilon}\).

    By definition, \(D\paren{z_0,\varepsilon}\subseteq U\). For any point \(z'\) in this disk, since 
\end{proof}
\begin{remark}
