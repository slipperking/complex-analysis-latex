...
\begin{theorem}\label{thm:identityaccumulationofzeroes}
    Let \(U\subseteq\mathbb{C}\), and \(f:U\to\mathbb{C}\) be holomorphic over \(U\). Then if the set \(E=\cbraces{z\in U\mid f(z)=0}\) has an accumulation point in \(U\), then \(f\equiv0\) over \(U\).
\end{theorem}
\begin{proof}
...
\end{proof}
\begin{theorem}[Argument Principle]\label{thm:argumentprinciple}
    Let \(U\subseteq\mathbb{C}\) be a region and \(f:U\to\mathbb{C}\) be holomorphic. Let \(\gamma\subset U\) be a closed curve homotopic to a constant curve (the homotopy lies in \(U\)). Then, 
\end{theorem}
