...
In Riemann's original paper, he used a modified version of the Riemann--\(\zeta\) function, known as the Riemann--\(\xi\) function. Following his own convention, we will use \(s=\sigma+\ii t\) as our primary variable.
\end{document}
