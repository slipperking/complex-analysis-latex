...
\end{lemma}
\begin{proof}
    Let \(K_{-1}=K_0=\emptyset,K_1,K_2,\cdots\subset\Omega\) exhaust \(\Omega\). Define two sequences, \(\paren{W_n}=K_{n+1}^\circ\setminus K_{n-2}\) be open and \(\paren{V_r}=K_r\setminus K_{r-1}^\circ\) be compact.
\end{proof}
