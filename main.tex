...
\begin{proof}
    ...
    Since both derivatives are positive, \(\abs{f'(z_1)}\leq\frac{1-\overline{w_1}w_1}{1-\overline{z_1}z_1}\). Since \(z_1\in D(0,1)\) is arbitrary, it follows that \[\abs{\dv{w}{z}}\leq\frac{1-\overline{w}w}{1-\overline{z}z}\Longleftrightarrow\frac{\abs{\dd{w}}}{1-\overline{w}w}\leq\frac{\abs{\ddz}}{1-\overline{z}z}.\]
...
\end{proof}
\begin{remark}
    In \autoref{sec:differentialgeometry}, we will introduce the \textit{hyperbolic metric}, defined as \[\dd{s}^2=\frac{4\dd{\overline{z}}\ddz}{\qty(1-\abs{z}^2)^2}\]
\end{remark}
