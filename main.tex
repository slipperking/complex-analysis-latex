...
\begin{proof}
    ...
    Notice that \(h_j(z)\) may not vanish over the boundary of the disk either, since otherwise there would be a root on the disk boundary, and another disk centered 
\end{proof}
