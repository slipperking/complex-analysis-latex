...
\begin{proof}
    ...
    \end{align*}
    where the leftover terms have a form resembling \[\paren{z-z_0}^2\frac{k!}{2\pi i}\brackets{k+1+\begin{pmatrix}
            k+1\\2
        \end{pmatrix}}\oint_{\partial U}\frac{f(\zeta)}{\paren{\zeta-z_0}^{k+3}}\ddzeta+\paren{z-z_0}^3\paren{\cdots}.\]
\end{proof}
