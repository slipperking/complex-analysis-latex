...
For simplicity, we will have \(\mathbb{D}\) denote the unit open disk, or \(D(0,1)\). The following important result can be directly obtained from the Maximum Modulus Principle.
