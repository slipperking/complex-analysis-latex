...
\end{theorem}
The Möbius transformation subgroup of \(\Aut(\mathbb{D})\) is also a subgroup of \(\Aut\qty(\riemannsphere)\). In particular, \(\varphi_z(\zeta)=\frac{\zeta-z}{1-\overline{z}\zeta}\). 
