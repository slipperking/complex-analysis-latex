...
\begin{lemma}[Schwarz--Pick Lemma]\label{lemma:schwarzpick}
    ...
    \[\abs{\frac{w_1-w_2}{1-w_1\overline{w_2}}}\leq\abs{\frac{z_1-z_2}{1-z_1\overline{z_2}}},\quad\frac{\abs{\dd{w}}}{1-\qty|w|^2}\leq\frac{\abs{\ddz}}{1-\qty|z|^2}.\]
...
\begin{proof}
    ...
    It follows that \(\varphi_{w_1}\circ f\circ\varphi_{-z_1}(0)=\varphi_{w_1}\qty(w_1)=0\). By the Schwarz Lemma (\autoref{lemma:schwarz}), \[\abs{\varphi_{w_1}\circ f\circ\varphi_{-z_1}(z)}\leq\abs{z}\] for \(z\in D(0,1)\).
\end{proof}
