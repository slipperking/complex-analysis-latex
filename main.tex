...
\begin{proof}
    ...
    $X$ must also be a closed set. For the sake of contradiction, assume that there exists a point $x_0\in\overline{X}\setminus X$. Construct a collection of open sets covering $X$:
