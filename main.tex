...
Let \(\zeta=\frac{1}{z}\). Then we get that \[\residue_{\zeta=0}f\qty(\frac{1}{\zeta})=-\int_{|\zeta|=\frac{1}{\rho}}f\qty(\frac{1}{\zeta})\dd(\frac{1}{\zeta})=\int_{\partial D\qty(0,\frac{1}{\rho})}\frac{f\qty(\frac{1}{\zeta})}{\zeta^2}\ddzeta.\]
