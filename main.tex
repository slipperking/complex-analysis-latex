...
\end{definition}
In order to ensure the existence of a quotient group, the subgroup must be normal. Let \(g_1,g_1'\in G\) form the same left coset (\(g_1H=g_1'H\)), and let \(g_2,g_2'\in G\) satisfy \(g_2H=g_2'H\). We must ensure that \((g_1H)*(g_2H)=(g_1'H)*(g_2'H)\).
