...
\begin{theorem}[Argument Principle for Holomorphic Functions]\label{thm:argumentprincipleholomorphic}
    ...
    Let \(\Gamma\) be the image of \(\gamma\) under \(f\). Then, \(k=\frac{1}{2\pi}\Delta_{f\in\Gamma}\arg(f)\), where \(\Delta_{f\in\Gamma}\arg(f)=\Delta_{z\in\gamma}\arg f(z)\).
\end{theorem}
\begin{proof}
