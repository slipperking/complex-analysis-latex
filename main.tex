...
Then \(e^z\) is periodic over \(2\pi i\). The complex logarithm, denoted \(w=\Log(z)\), is the solution to \(z=e^w\). We can define the power function for non-integer powers with 
