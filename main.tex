...
If \(u\qty(z)\) is continuous on \(\partial\mathbb{D}\), and therefore \(u\circ\exp(i\tau)\) is periodic over \(2\pi\). Thus, it can be written as a Fourier series \[u\qty(e^{i\tau})\sim\sum_{-\infty }\]
