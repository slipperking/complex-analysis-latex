...
\end{example}
\begin{proof}
    It is evident that \(f(z)=\csc(\pi z)\) has double poles at each of \(z=n\in\mathbb{Z}\) with principal parts \(\frac{1}{z-n}\residue_{z=n}f(z)+\frac{1}{\qty(z-n)^2}\residue_{z=n}zf(z)\).
\end{proof}
