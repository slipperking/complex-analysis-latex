...
\end{theorem}
A curve is a one dimensional manifold embedded in higher dimensional space. They can be parameterized with a vector \(\begin{pmatrix}
    P(t)\\Q(t)\\R(t)
\end{pmatrix}\) of one parameter. In the complex plane, a curve is a complex valued function \(\gamma(t)\) for a real parameter \(t\). 
