...
\begin{example}
    A \textit{Legendre polynomial} is a polynomial in the form of \[P_n(z)=\frac{1}{2^nn!}\dv[n]{z}(\qty(z^2-1)^n),\] a formula given by Olinde Rodrigues. Prove the integral form \[P_n(z)=\]
\end{example}
