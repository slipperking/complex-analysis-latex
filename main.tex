...
\begin{proof}
    ...
    We want to show that \(\exists\delta>0\) (independent of \(n>\max\qty(N,N')\)) such that \(\forall n>\max\qty(N,N')\), \(\forall z\in D\qty(z_0, \delta)\setminus\qty{0}\), \[\qty|\frac{S_n(z)-S_n\qty(z_0)}{z-z_0}-S'_n(z)|<\frac{\varepsilon}{3}.\]
