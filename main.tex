...
\begin{proof}
    ...
    Hence, \(z\) maps \(\partial\mathbb{D}\) to \(\mathbb{R}\), and \(w\) maps \(\mathbb{R}\) to \(\partial\mathbb{D}\) univalently and surjectively. Since \(\mathbb{R}\) can be considered as a circle of infinite radius, \(w\) is a biholomorphism from \(\mathbb{H}^+\) to \(\mathbb{D}\) by \autoref{thm:boundaryofconformalmap}. 
\end{proof}
