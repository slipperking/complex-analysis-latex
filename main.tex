...
\begin{definition}[Meromorphic Function]\label{def:meromorphicfunction}
    Let \(U\subseteq\mathbb{C}\) be open. Let \(\cbraces{a_n}_{n\in\mathbb{N}}\subset U\) be a set of isolated points. Suppose \(f:U\setminus\cbraces{a_n}\to\mathbb{C}\) is holomorphic 
\end{definition}
