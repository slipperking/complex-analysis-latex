...
\begin{proof}
    ...
    Since the side length of each box tends to 0, \(\bigcap_{i=0}^\infty Q_i\) consists of a single point $z_{\infty}\in\mathbb{C}^n$. Since $Q_i\cap X\neq\emptyset$, select a point \(z_{i}\in Q_i\cap X\)
\end{proof}
