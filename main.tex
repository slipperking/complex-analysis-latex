...
Then \(\cos(z)=w\circ\zeta\circ\xi(z)\). \(\xi\) is univalent over \(\mathbb{C}\) as it is a rotation. \(\zeta\) is univalent over any region \(U\) such that \(\forall\xi_1,\xi_2\in U\) 
