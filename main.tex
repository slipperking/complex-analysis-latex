...
\begin{proof}
    ...
    Assume that there exists an infinite open cover \(\mathcal{U}\) of \(X\) without a finite subcover. Bisect $Q$ into $2^{2n}$ sub-boxes. Choose $Q_1$ such that $Q_1\cup X$ has no finite subcover of $\mathcal{U}$. Under the previous assumptions, this is possible since if every sub-box had finite subcovering, Similarly, choose $Q_2$ by bisecting $Q_1$ in a similar way.
\end{proof}
