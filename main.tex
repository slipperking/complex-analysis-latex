...
Hence, \(\lim_{\rho\to1^-}\frac{1}{2\pi\rho}\int_0^{2\pi}\Phi\qty(\rho e^{i\theta})\dd{\theta}=\frac{1}{2\pi\rho}\int_0^{2\pi}\Phi\qty( e^{i\theta})\dd{\theta}=\Phi(0)\). Let \(\phi(z)=\Phi\circ\varphi_a\)
