...
\begin{proof}
    ...
    and through similar logic, \[\int_{\overrightarrow{N_1Q_1}}f(z)\ddz\to\int_{\overrightarrow{NQ}}f(z)\ddz.\] Therefore, \[\int_{MNQP}f(z)\ddz=0.\]
    Any region with a simple closed continuous boundary can be broken up into regions with the same form as \(MNQP\)
\end{proof}
