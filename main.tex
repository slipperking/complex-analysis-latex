...
\begin{proof}
    ...
    Notice that \(\ee^{\varphi(z)}=\frac{\sin(\pi z )}{z\prod_{n=1}^\infty\qty(1-\frac{z^2}{n^2})}\). As \(z\to 0\). we have \[e^{\varphi(0)}=\frac{\pi}{\prod_{n=1}^\infty\qty(1-\frac{z^2}{n^2})+z\qty[\prod_{n=1}^\infty\qty(1-\frac{z^2}{n^2})]'_{z=0}}\]
\end{proof}
