...
\end{theorem}
\begin{proof}
    By the holomorphy of \(f_n(z)\), \(\forall z\in U\), we can choose an arbitrary simple closed rectifiable curve \(\gamma\in\mathbb{U}\) enclosing \(z\). By the Cauchy--Goursat Integral Formula (\autoref{thm:cauchygoursatformula}), \[f(z)=\int_{\gamma}\frac{f_j\paren{\zeta}}{\zeta-z}\ddzeta\]
\end{proof}
