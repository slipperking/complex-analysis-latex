...
\begin{proof}
    ...
    Since \(f\) and \(f'\) are holomorphic over \(\gamma\). By \autoref{thm:continuousfunctionboundedoncompact}, there exists a vaThen,
    \begin{align*}
        \abs{\frac{f'}{f}-\frac{f'_n}{f_n}}&=\abs{\frac{f'f_n-f'_nf}{f_nf}}\\
        &<\frac{\abs{f'f_n-f'f}+\abs{f'f-f'_nf}}{\frac{2}{\delta^2}}\\
        &<\delta^2\frac{\abs{f'}\delta/2+\abs{f}\abs{f'-f'_n}}{2}
    \end{align*}
\end{proof}
