...
Let us first confirm injectivity. \(\forall\zeta_1,\zeta_2\in D(0,1)\), we will observe when \[\frac{z-\zeta_1}{1-\overline{z}\zeta_1}=\frac{z-\zeta_2}{1-\overline{z}\zeta_2}\] is satisfied. It follows that \[\qty(z-\zeta_1)\qty(1-\overline{z}\zeta_2)=\qty(z-\zeta_2)\qty(1-\overline{z}\zeta_1).\]
