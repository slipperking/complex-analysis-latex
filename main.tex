...
\end{example}
\begin{definition}[Base of a Topology]
    For a topological space \((X,\tau)\), the base \(\mathcal{B}\) is defined to be a collection of subsets of \(X\) such that every set in \(\tau\) is equal to the union of certain sets in \(\mathcal{B}\)
\end{definition}
\begin{lemma}
