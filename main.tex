...
\begin{proof}
    ...
    \begin{align*}
        \int_{\gamma} \frac{1}{\qty(z^2+1)^{n+1}}\ddz & =\int_{-R}^R\frac{1}{\qty(x^2+1)^{n+1}}\ddx+\int_0^\pi\frac{Ri}{\qty(R^2e^{2\ii\theta}+1)^{n+1}}\ee^{\ii\theta}\dd{\theta} \\
        & =2\pi\ii\cdot\residue_{z=\ii}\frac{1}{\qty(z^2+1)^{n+1}}=\frac{(2n)!\pi}{2^{2n}(n!)^2}.
    \end{align*}
