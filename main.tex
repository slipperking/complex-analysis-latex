...
\end{proof}
In \autoref{thm:greatpicard}, we will prove a profound generalization of this result, which was first proved by Émile Picard in 1879: \textit{the image of any open punctured neighborhood of an essential singularity will attain every value in \(\mathbb{C}\), except for at most one possible exception, infinitely often}.
