...
\end{example}
\begin{proof}
    It is evident that \(\csc^2(\pi z)\) has double poles at each of \(z=n\in\mathbb{Z}\). The principal part of the Laurent expansion of \(\csc^2(\pi z)\) at \(z=n\) is \[\psi_m(\zeta)=\]
\end{proof}
