...
where \(z\in D(0,R)\). Since \(R>0\) and \(\zeta-z\neq0\), the function \(f(z)=\frac{1}{2\pi i}\int_{\partial D(0,R)}\frac{u(\zeta)}{\zeta}\frac{\zeta+z}{\zeta-z}\ddzeta\) is holomorphic, \(u(z)\) the real part of a holomorphic function.
