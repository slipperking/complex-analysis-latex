...
\begin{proof}
    ...
    By the chain rule, \(\abs{\varphi_{w_1}'\qty(w_1)f'\qty(z_1)\varphi_{-z_1}'(0)}\leq1\). Let us now calculate the derivatives of \(\varphi_{w_1}\) and \(\varphi_{-z_1}\). By the quotient rule, \[\varphi'_{w_1}=\frac{1-\overline{w_1}z+\overline{w_1}\qty(z-w_1)}{\paren{1-\overline{w_1}z}^2}=\frac{1-\abs{w_1}^2}{\paren{1-\overline{w_1}z}^2}\]
\end{proof}
