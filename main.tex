...
\begin{proof}
    ...
    Similarly, \(a_1=0\). We recursively obtain that \(a_0,a_1,\ldots=0.\) Then \(f\equiv0\) over \(D\paren{z_0,\varepsilon}\). To extend this to \(U\), 
\end{proof}
\begin{remark}
...
\begin{theorem}[Argument Principle]\label{thm:argumentprinciple}
    Let \(U\subseteq\mathbb{C}\) be a region and \(f:U\to\mathbb{C}\) be holomorphic. Let \(\gamma\subset U\) be a closed curve homotopic to zero.
\end{theorem}
