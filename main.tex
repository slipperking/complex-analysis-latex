...
\begin{definition}[Meromorphic Function]\label{def:meromorphicfunction}
	Let \(U\subseteq\mathbb{C}\) be open, and let \(\cbraces{a_n}_{n\in\mathbb{N}}\subset U\) be a set of isolated points. Suppose \(f:U\setminus\cbraces{a_n}\to\mathbb{C}\) is holomorphic and has a pole at each of \(z\in\qty{a_n}\). Then \(f\) is \textit{meromorphic} in \(U\).
\end{definition}
...
\begin{proof}
	...
	\end{align*}
	Let us evaluate the integral on \(\gamma_\varepsilon\) as \(\varepsilon\to 0\):
	\begin{align*}
		\int_{\gamma_\varepsilon}f(z)\ddz&=\int_\pi^0\frac{\exp(i\varepsilon e^{i\theta})}{\varepsilon e^{i\theta}}\varepsilon ie^{i\theta}\dd{\theta}=i\int_\pi^0 e^{i\varepsilon\cos\theta}e^{-\varepsilon\sin\theta}\dd{\theta}
	\end{align*}
\end{proof}
