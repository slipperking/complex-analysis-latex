...
The derivative along $\alpha=1$, \(\beta=0\) (or the real axis) is indeed 0. Along $\alpha=0$, \(\beta=1\) (or the imaginary axis), it is also 0. However the limit is different for any other direction of approach
