...
\begin{enumerate}
    ...
    \end{theorem}
    The proof follows from the classification of the limits of \(f(z)\) and the principle part of the Laurent expansion from \ref{itm:isolatedsingularities_removable} and \ref{itm:isolatedsingularities_pole}.
\end{enumerate}
