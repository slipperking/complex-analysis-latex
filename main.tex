...
\end{example}
\begin{proof}
    The analytic element \(\qty(D\qty(0,\abs{\frac{1}{\alpha}}),f)\) can be directly continued to the analytic element \(\qty(\mathbb{C}\setminus\qty{\frac{1}{\alpha}},z\mapsto\frac{1}{1-\alpha z})\). The element \(\qty(D\qty(0,\frac{1-z}{\alpha-1}),\widetilde{f})\) can be analytically continued to \(\qty(,\frac{1}{(1-z)\qty(1-\frac{z\alpha-z}{1-z})})\)
\end{proof}
