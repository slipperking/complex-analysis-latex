...
\begin{proof}
    ...
    \(\forall\zeta\in\gamma_2\) (or \(|\zeta-a|=R'\)), \(\abs{z-a}<\abs{\zeta-a}\) and therefore, \(\frac{\abs{z-a}}{\abs{\zeta-a}}<1\). It follows that \[\frac{1}{\zeta-z}=-\frac{1}{(z-a)\qty(1-\dfrac{\zeta-a}{z-a})}=\]
\end{proof}
