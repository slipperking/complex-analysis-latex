...
\begin{proof}
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \draw[thin, |-|, line cap=round, shorten >=1pt] (0,0) -- (3.03,1.75) node[midway, anchor=east] {\(R\)};
            \draw[thin, |-|, line cap=round, shorten >=1pt] (0,0) -- (0,2) node[midway, right] {\(r\)};
            \draw[thin, |-|, line cap=round, shorten >=1pt] (0,0) -- (2.87,-1.65) node[midway, anchor=south] {\(R'\)};
            \draw[thin, |-|, line cap=round, shorten >=1pt] (0,0) -- (-1.48,-1.64) node[midway, anchor=south east] {\(r'\)};
