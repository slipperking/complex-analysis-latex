...
Similarly, assuming \(\qty{z_k}_{k=1}^n\subset\mathbb{C}\) is a sequence of distinct complex numbers, let \(\qty{w_{k,j}}_{\substack{k\in\qty{1,\ldots,n}\\ j\in \qty{1,\ldots,n_k}}}\) be a sequence.
