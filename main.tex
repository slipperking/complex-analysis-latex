...
\begin{proof}
    ...
    Since the integrand is dominated by a function that has a convergent integral (\(\int_{\supp(\psi)}M\dd{\xi}\wedge\dd{\overline{\xi}}\)), equation \eqref{eq:onedimensionalpartialconjugatesolution_differenceexpr} uniformly converges and the limit \(\z_0\to z\) may commute with the double integral, or \[\pdv{\psi\paren{\xi+z}}{z}=\frac{1}{2\pi i}\int_{\mathbb{C}}\frac{\psi(\xi+z)-\psi\paren{\xi+z_0}}{\xi\paren{z-z_0}}\dd{\xi}\wedge\dd{\overline{\xi}}\]
\end{proof}
