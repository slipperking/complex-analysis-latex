...
\end{proof}
The following is also a direct result from Rouché's Theorem (\autoref{thm:rouche}). Unlike \autoref{thm:hurwitz}, which concerns the stability of zeros under perturbations of \(f_n(z)\) for large \(n\), we can directly consider perturbations of \(f(z)+\zeta\) for small \(\zeta\) 
