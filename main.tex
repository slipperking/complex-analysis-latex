...
\begin{proof}
    ...
    \begin{align*}
        ...
        &=\lim_{\zeta\to n}\frac{2\qty(\zeta-n)}{\pi\sin(2\pi\zeta)}+(z-n)\lim_{\zeta\to n}\frac{2(\zeta-n)+2\pi(\zeta-n)^2\cos(\pi\zeta)\csc(\pi\zeta)}{\sin[2](\pi\zeta)}\\
        &\quad+\order{(z-n)^2}\\
        &=\lim_{\zeta\to n}\frac{2}{2\pi^2\cos(2\pi\zeta)}+(z-n)\lim_{\zeta\to n}\frac{2+2\pi(\zeta-n)^2\cot(\pi\zeta)}{\sin[2](\pi\zeta)}
    \end{align*}
\end{proof}
