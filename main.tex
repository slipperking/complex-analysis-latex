...
\end{proof}
\begin{remark}
    In the first part, we established that a function \(\psi(z)\in C^1(\mathbb{C})\) with compact support satisfied \[\int_{\mathbb{C}\setminus D\paren{z,\varepsilon}}\frac{\psi(\zeta)}{\zeta-z}\dd{\overline{\zeta}}\wedge\ddzeta=0\]
\end{remark}
