...
\begin{theorem}[Abel's Theorem]
    For a power series \(\sum_{n=0}^\infty a_nz^n\), there exists a constant \(R\in\mathbb{R}_{\geq0}\cup\cbraces{\infty}\) such that the power series absolutely converges over \(\abs{z}<R\), and \(\forall 0\leq\rho<R\), uniformly converges on \(\abs{z}\leq\rho\).
\end{theorem}
