...
\begin{proof}
    ...
    We can differentiate within the integral as \(f\) is bounded over any compact set in \(U\), the partial derivative is compactly supported, and the integrand is dominated by an integrable function:
    \[f^{(n)}(z)=\]
\end{proof}
