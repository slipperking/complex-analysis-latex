...
\begin{proof}
    ...
    \begin{align*}
        ...
        &<2\frac{\abs{f'f_n-f'f}+\abs{f'f-f'_nf}}{\delta^2}\\
        &<\frac{2M}{\delta^2}\cdot\paren{\abs{f_n-f}+\abs{f'-f'_n}}\\
        &<2M\delta.
    \end{align*}
