...
This preludes to the following fact: a non-constant holomorphic function cannot attain a local minimum or maximum of its modulus inside its domain. Such extrema can only occur on the boundary, as formalized in the following theorem:
