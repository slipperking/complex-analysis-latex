...
\begin{proof}
    ...
    \end{cases}.\]
    By the continuity of \(f\) on \(\partial D(0,R)\), it attains its maximum \(M\). For sufficiently large \(R\), \(\abs{\zeta-z}\) attains a positive minimum. Then the integrand is uniformly bounded. Therefore, we can commute the limit with the integral, and hence, \begin{align*}
