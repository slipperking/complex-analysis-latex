...
\end{theorem}
The two forms of the theorem show that differentiation and integration are inverse operations to each other. Operations performed before differentiating oftentimes can be done before integrating:
\[\]
