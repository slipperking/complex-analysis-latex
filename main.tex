...
\end{equation}
The significance of this alternative formula implies that a holomorphic function can be recovered from the real part of a holomorphic function over the boundary of a disk and a single
