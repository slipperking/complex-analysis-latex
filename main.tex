...
\end{proof}
\begin{remark}
    This is a trivial property of holomorphic functions that allow for the uniqueness of analytic continuations. It is oftentimes stated in the form below:
\end{remark}
\begin{theorem}[Identity Theorem]\label{thm:identity}
    Let \(U\subseteq\mathbb{C}\) be a region and two hol
\end{theorem}
