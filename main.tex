...
\begin{proof}
    ...
    Finally, \(\exists\delta>0\) (by continuity and \autoref{thm:uniformlimit} on \([-\rho,\rho]\)) such that \(\forall n>\max\qty(N,N')\), \(\forall z\in D\qty(z_0, \delta)\), \[\qty|\frac{S_n(z)-S_n\qty(z_0)}{z-z_0}-S'_n(z)|<\frac{\varepsilon}{3}.\]
...
\begin{lemma}[Schwarz--Pick Lemma]\label{lemma:schwarzpick}
    ...
    \[\abs{\frac{w_1-w_2}{1-w_1\overline{w_2}}}\leq\abs{\frac{z_1-z_2}{1-z_1\overline{z_2}}},\quad\frac{\abs{\dd{w}}}{1-\qty|w|^2}\leq\frac{\abs{\ddz}}{}\]
\end{lemma}
