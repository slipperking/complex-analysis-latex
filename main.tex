...
\end{align}
The constant \(\gamma=\int_1^\infty\qty(\frac{1}{\floor{x}}-\frac{1}{x})\ddx\) is known as the \textit{Euler--Mascheroni constant}. Equation~\eqref{eq:gammafunctionweierstrassformula} is known as the \textit{Weierstrass formula} for the reciprocal Gamma function.
\end{document}
