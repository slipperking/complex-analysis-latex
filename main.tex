...
\begin{proof}
    ...
    Since \begin{align*}
        ...
        &=\frac{z-z_0}{2\pi i}\int_{\partial U}\frac{f(\zeta)}{(\zeta-z)\paren{\zeta-z_0}^2}\ddzeta.
    \end{align*}
    Let \(d\) be the distance from \(z_0\) to \(\partial U\), and choose \(r=\frac{d}{2}\). Then, since \(\abs{z-z_0}<r\) and \(\abs{}\)
\end{proof}
