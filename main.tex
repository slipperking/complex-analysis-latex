...
\end{proof}
\begin{remark}
    By induction, we have shown that the assuming existence of the first order derivative of a holomorphic function \(f\), the \(n\)th order derivative of \(f\) exists \(\forall n\in\mathbb{N}\). Furthermore, if \(f\) is holomorphic, then \(\forall z\in U\), there exists a neighborhood enclosing \(z\) such that \(f\) has a convergent Taylor expansion.
\end{remark}
