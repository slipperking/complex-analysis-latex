...
\begin{equation}
    u\qty(e^{i\theta})\sim\sum_{n=-\infty}^\infty a_ne^{in\theta},\qquad a_n=\frac{1}{2\pi}\int_{-\pi}^\pi u\qty(e^{i\tau})e^{-in\tau}\dd{\tau}.\label{eq:poissonintegralformulafourierseries}
\end{equation}
...
By substituting the coefficients, we have \begin{align*}
    \sum_{n=-\infty}^\infty a_ne^{in\theta}\rho^{|n|}&=\sum_{n=0}^\infty a_n e^{in\theta}\rho^n+\sum_{n=1}^\infty a_{-n}e^{-in\theta}\rho^n
\end{align*}
