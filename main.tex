...
\end{theorem}
\begin{proof}
    Let \(\gamma_2,\gamma\subset V\) be two simple closed curves such that \(\gamma_2\) completely encloses \(\gamma_1\) without intersection and \(\gamma\) encloses \(a\). By the Cauchy--Goursat Integral Formula (\autoref{thm:cauchygoursatformula}), \[\]
\end{proof}
