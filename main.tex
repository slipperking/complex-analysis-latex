...
\begin{proof}
	...
	Notice that \(\abs{\sin(x)}\leq x\) over the integration range. We want to observe the behavior as \(R\to\infty\): \[\abs{i\int_0^\pi e^{iR\cos\theta}e^{-R\sin\theta}\dd{\theta}}\leq\int_0^{\pi}e^{-R\sin\theta}\dd{\theta}<\int_0^{\pi}e^{-R\sin\theta}\dd{\theta}.\]
\end{proof}
