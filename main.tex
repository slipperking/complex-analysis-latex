...
It follows that \(\varphi_z=\qty(\varphi_z)^{-1}\). Thus \(\varphi_z\) is surjective and consequently bijective. It follows that equation \eqref{eq:mobiustransformationgroupofholomorphicautomorphismsstatement} is true.
