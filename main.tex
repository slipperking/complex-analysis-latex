...
\begin{theorem}[Stokes' Theorem]\label{theorem:stokes}
    Let \(S\) be an oriented, smooth surface in \(\mathbb{R}^3\) with positively oriented boundary curve \(\partial S\). Let \(P(x,y,z),Q(x,y,z),R(x,y,z)\in C^1(\overline{S})\). Then,
