...
\begin{proof}
    ...
    We will first prove that \(f\) has finitely many poles in \(\overline{D(0,R)}\). If \(f\) has infinitely many poles in the closed disk, by the Bolzano--Weierstrass Theorem (\autoref{thm:bolzanoweierstrass}), there is an accumulation point of poles. Then this point 
\end{proof}
