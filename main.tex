...
\end{lemma}
\begin{proof}
    By the Cauchy Criterion (\autoref{thm:cauchycriterionuniformconvergence}), \(\forall\varepsilon>0\), \(\exists N\in\mathbb{N}\) such that \(\forall n,m>N\), \[\sup_{z\in\partial U}\qty|f_|\]
    By the Maximum Modulus Principle (\autoref{thm:maximummodulus}),
\end{proof}
