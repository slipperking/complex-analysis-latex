...
is a Laurent Series at the point \(a\). The series can be separated into a power series with non-negative exponents, \begin{equation}
    \sum_{n=0}^\infty c_n(z-a)^n,\label{eq:laurentseriesnon-negativeexponents}
...
\end{equation} Equation~\eqref{eq:laurentseries} is said to be convergent at \(z=z_0\) if the two power series are both convergent.
