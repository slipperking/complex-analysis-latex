...
\begin{enumerate}
    \item If \(z=\infty\) is a removable singularity of \(f(z)\), then \(f(z)\) has the form \[f(z)=c_0+\frac{c_1}{z}+\frac{c_2}{z^2}+\cdots.\]
    \item If \(z=\infty\) is a pole of \(f(z)\) with degree \(m\in\mathbb{N}\), then \(f(z)\) can be written as \[f(z)=c_{-m}z^m+\cdots c_0+\frac{c_1}{z}+\cdots,\] where \(c_{-m}\neq0\).
\end{enumerate}
