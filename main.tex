...
\begin{proof}
    Define the auxiliary function \[g(z)=\begin{cases}
        ...
        f'(0)&z=0
    \end{cases}.\]
    Because \(\lim_{z\to0}\frac{f(z)}{z}=f'(0)\), \(g(z)\) is holomorphic on \(D(0,1)\). \(\forall0<\varepsilon<1\), \(\forall z\in D(0,\varepsilon)\), \[\abs{g(z)}\leq\max_{z_\varepsilon\in D(0,\varepsilon)}\frac{\abs{f\paren{z_\varepsilon}}}{\varepsilon}\]
\end{proof}
