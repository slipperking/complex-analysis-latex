...
\begin{enumerate}
    ...
    Let \(z_1=x_1+iy_1\), \(z_2=x_2+iy_2\), \(x_1,y_1,x_2,y_2\in\mathbb{R}\) satisfy \(e^{z_1}=e^{z_2}\). Then, \[e^{x_1}e^{iy_1}=e^{x_2}e^{iy_2}.\] The moduli are equal, and therefore \(x_1=x_2\), and by the periodic nature of the exponentiation of imaginary numbers, \(y_1-y_2=2k\pi\), where \(k\in\mathbb{Z}\). To satisfy the univalence over a region \(U\), \(z_1-z_2\neq2i\pi k\)
\end{enumerate}
