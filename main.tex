...
\begin{example}
	Evaluate the improper integral \(I=\int_{-\infty}^\infty \frac{1}{\qty(x^2+1)^{n+1}}\ddx\).
\end{example}
\begin{proof}
	\begin{figure}
		\centering
