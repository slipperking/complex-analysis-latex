...
\end{proof}
Since the real and imaginary parts of holomorphic functions are real-valued harmonic functions, they also satisfy the mean-value property. Furthermore, if a real continuous function satisfies the mean-value property, it is harmonic (we will prove this in \autoref{sec:}) TO BE CONTINUED. This equivalence allows for the alternative definition of harmonic functions.
...
TO BE CONTINUED
Lastly, we will prove the logical equivalence between the mean-value property and the solution equation
