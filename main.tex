...
\begin{proof}
    ...
    \[\mathcal{U}=\left\{\mathbb{C}^n\setminus\overline{B}\left(x_0,\frac{1}{k}\right)\;\middle|\; \forall k\in\mathbb{N}\right\}.\] This collection covers the set $X$. By assumption, there exists a finite subcover \(\left\{\mathbb{C}^n\setminus\overline{B}\left(x_0,\frac{1}{k_i}\right)\;\middle|\; k\in\mathbb{N}\right\}\)
\end{proof}
