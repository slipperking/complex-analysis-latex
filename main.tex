...
\begin{example}\label{ex:cscpoleexpansion}
    Prove the pole expansion formula of \[\csc(\pi z)=\frac{1}{\pi}\qty[\frac{1}{z}+\sum_{n=1}^\infty \frac{2z(-1)^n}{z^2-n^2}]\] for \(z\in\mathbb{C}\setminus\mathbb{Z}\).
\end{example}
\begin{example}\label{ex:cotpoleexpansion}
    Prove the pole expansion formula of \[\cot(\pi z)=\frac{1}{\pi}\qty[\frac{1}{z}+\sum_{n=1}^\infty \frac{2z}{z^2-n^2}]\] for \(z\in\mathbb{C}\setminus\mathbb{Z}\).
\end{example}
