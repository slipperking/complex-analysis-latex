...
\begin{proof}
    ...
    Let \(f_1(z)=\lim_{n\to\infty}S_n'(z)=\sum_{n=0}^\infty na_nz^{n-1}\). We aim to show that \(f'(z)=f_1(z)\). Let \(\rho<R\) be positive and \(\abs{z_0}<\rho\). Then, \[\frac{f(z)-f\qty(z_0)}{z-z_0}-f_1(z)=\lim_{n\to \infty}\qty(\frac{S_n(z)-S_n\qty(z_0)}{z-z_0}-S'_n(z)+S'_n(z)+\frac{R_n(z)-R_n\qty(z_0)}{z-z_0}-f_1(z))\]
\end{proof}
