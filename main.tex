...
\begin{proof}
	...
	\end{align*}
	Let us evaluate the integral on \(\gamma_\varepsilon\) as \(\varepsilon\to 0\): \[\int_{\gamma_\varepsilon}f(z)\ddz=i\int_{\gamma_\varepsilon}e^{i\varepsilon\qty(\cos\theta+i\sin\theta)}\dd{\theta}=\]
\end{proof}
