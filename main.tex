...
\begin{proof}
    ...
    Now assume that equation \eqref{eq:cauchydifferentiationformula_statement} is true for some \(n=k\in\mathbb{N}\), or \[f^{(k)}(z)=\frac{k!}{2\pi i}\oint_{\partial U}\frac{f(\zeta)}{\paren{\zeta-z}^{k+1}}\ddzeta.\]
\end{proof}
