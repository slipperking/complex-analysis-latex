...
\end{proof}
The following is also a direct result from Rouché's Theorem (\autoref{thm:rouche}):
\begin{theorem}\label{thm:zerosofashiftedholomorphicfunctionoverneighborhood}
    Let \(U\subseteq\mathbb{C}\) be open and \(f(z)\) be holomorphic on \(U\). If \(f\) has a zero at \(z_0\in U\), 
\end{theorem}
