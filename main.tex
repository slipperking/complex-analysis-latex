...
\begin{proof}
    ...
    Because the integrand is uniformly bounded by \(M\), with the integral \(\int_{\supp(\psi)}M\dd{\xi}\wedge\dd{\overline{\xi}}\), equation~\eqref{eq:onedimensionalpartialconjugatesolution_differenceexpr} uniformly converges, and the limit \(h\to0\) may commute with the integral. Let \(\zeta=\alpha+i\beta\). From the real axis, \begin{equation}
