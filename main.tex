...
\end{proof}
Since the real and imaginary parts of holomorphic functions are harmonic functions, they also satisfy the mean-value property. Since harmonic functions satisfy \(\Delta f=0\), they too do not have local minima or maxima.
