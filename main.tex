...
\end{example}
\begin{proof}
    Let \(z=e^{i\theta}\). Consequently, we have \(\cos\theta=\frac{z+z^{-1}}{2}\), \(\sin\theta=\frac{z-z^{-1}}{2i}\), and \(\ddz=ie^{i\theta}\dd{\theta}\), implying that \(\dd{\theta}=\frac{\ddz}{iz}\). Therefore, letting \(f(z)=\frac{1}{iz}\Phi\qty(\frac{z+z^{-1}}{2},\frac{z-z^{-1}}{2i})\), we have \[\int_0^{2\pi}\Phi(\cos\theta,\sin\theta)\dd{\theta}=\int_{\partial\mathbb{D}}f(z)\ddz=2\pi i\sum_{k=1}^n\residue_{z=z_k}f(z),\]
