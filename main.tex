...
\begin{proof}
    ...
    \begin{align*}
        \abs{f(z)}&\leq\abs{\frac{4}{\ee^{2\pi\ii z}+\ee^{-2\pi\ii z}-2}}+\frac{1}{\pi^2}\qty[\sum_{n=2}^\infty\frac{1}{\qty[n-\qty{\Re(z)}]^2}+\sum_{n=1}^\infty\frac{1}{\qty[n+\qty{\Re(z)}]^2}+\frac{1}{\abs{z}^2}+\frac{1}{\abs{1-z}^2}]\\
        &\leq ...+\frac{1}{\pi^2}\qty[\frac{\pi^2}{3}+\frac{}{}]
    \end{align*}
\end{proof}
