...
\begin{proof}
	...
	We will now analyze each integral. The first integral is \[\int_{\gamma_R}f(z)\ddz=\int_0^\pi\frac{\exp(Re^{i\theta})}{Re^{i\theta}}Rie^{i\theta}\dd{\theta}=i\int_0^{\pi}\exp(Re^{i\theta})\dd{\theta}\]
\end{proof}
