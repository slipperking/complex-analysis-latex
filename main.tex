...
Then, \[\abs{a}^2\paren{z_2-z_1}=z_2-z_1.\Longleftrightarrow\qty\big(\qty|a|^2-1)\qty(z_2-z_1)=0.\] Since \(\abs{a}<1\), we get \(z_2-z_2=0\). This proves the injectivity of \(\varphi_a(z)\).
