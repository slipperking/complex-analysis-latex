...
\begin{theorem}[The Holomorphic Automorphism Group on \(\riemannsphere\)]\label{thm:holomorphicautomorphismgrouponextendedcomplexplane}
    \(\forall f\in \Aut\qty(\riemannsphere)\), \(f\) is a Möbius transformation. In other words, \(\exists a,b,c,d\in\mathbb{C}\) and \(\exists\tau\in\mathbb{R}\) such that \[f(z)=\varphi_a\circ\rho_\tau(z).\]
\end{theorem}
