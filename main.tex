...
\begin{proof}
    ...
    When \(2k-2n-1\ge0\), the integrand is holomorphic. The integral is then equal to \[\binom{2n}{0}\int_{\partial\mathbb{D}}z^{-2n-1}\ddz+\binom{2n}{1}\int_{\partial\mathbb{D}}z^{-2n+1}\ddz+\cdots+\binom{2n}{n}\int_{\partial\mathbb{D}}\frac{\ddz}{z}=\binom{2n}{n},\]
    since all of the higher order terms vanish:
    \[\int_{\partial\mathbb{D}}z^{2k-2n-1}\ddz=\int_0^{2\pi} e^{i\theta\qty(2k-2n-1)}ie^{i\theta}\dd{\theta}=i\int_0^{2\pi}e^{2i\theta(k-n)}=\begin{cases}
        0& k< n\\
        2\pi i&k=n
    \end{cases}\]
\end{proof}
