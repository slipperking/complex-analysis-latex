...
\begin{proof}
    ...
    \begin{align*}
        ...
        &=M'\lim_{\varepsilon\to0}\abs{\int_{D(z,\varepsilon)}\frac{1}{re^{i\theta}}\dd(z+re^{-i\theta})\wedge\dd(z+re^{i\theta})}\\
        &=M'\lim_{\varepsilon\to0}\abs{\int_{D(z,\varepsilon)}\frac{1}{re^{i\theta}}\paren*{e^{-i\theta}\dd{r}-ire^{-i\theta}}\wedge\paren*{e^{i\theta}dr+ire^{i\theta}}}
    \end{align*}
\end{proof}
\end{document}