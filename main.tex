...
\begin{proof}
    ...
    \[\varphi(z)=\sum_{\substack{j\in\mathbb{N}\\\supp\paren{\alpha_j}\subseteq\Omega_2}}\alpha_j(z).\]
    It follows that \(\varphi\in C^\infty(\mathbb{C})\) with compact support in \(\Omega_2\).
\end{proof}
