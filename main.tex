...
\begin{proof}
    ...
    We will analyze the first integral as \(R\to\infty\). By the triangle and reverse triangle inequality, \[\qty|\int_0^{2\pi}\qty(f\qty(Re^{i\theta})-\frac{f\qty(Re^{i\theta})}{1-\frac{z}{Re^{i\theta}}})\dd{\theta}|\leq\int_0^{2\pi}\qty|\frac{z}{Re^{i\theta}-z}|\dd{\theta}\leq\int_0^{2\pi}\frac{|z|}{R-|z|}\dd{\theta}=\frac{2\pi|z|}{R-|z|}\to0.\]
    \end{enumerate}
