...
\end{example}
In a topological space \(X\), a subspace can either be open, closed (\(X\setminus U\), where \(U\) is open in \(X\)), both (clopen), or neither.
...
The topological space of \((\mathbb{R},\tau)\), where \(\tau=\cbraces{(n,n+1)}{n\in 2\mathbb{Z}}\)
