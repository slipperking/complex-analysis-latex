...
\end{example}
\begin{proof}
    It is evident that \(f(z)=\csc(\pi z)\) has double poles at each of \(z=n\in\mathbb{Z}\). The principal part of the Laurent expansion at each \(n\) is \[\psi_n(\zeta)=\lim_{z\to n}\frac{\dv{z}[z^2 f(z)]}{\zeta-n}+\lim_{z\to n}\frac{z^2 f(z)}{\qty(\zeta-n)^2}\]
\end{proof}
