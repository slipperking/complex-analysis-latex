...
We will now prove the primary assumption; the singularity at \(z=\infty\) cannot be an essential singularity of \(f(z)\). Let \(w\in\mathbb{C}\) be arbitrary. Then \(\forall R>0\), \(\forall\varepsilon>0\), \(\exists |z|>R\) such that \(|f(z)-w|<\varepsilon\). Therefore, \(\)
