...
\begin{proof}
    ...
    \begin{gather*}
        \overset{\uparrow}{\Gamma}=\cbraces{x+2i}{-R\leq x\leq R,x\in\mathbb{R}},\quad\overset{\downarrow}{\Gamma}=\cbraces{x\in\mathbb{R}}{-R\leq x\leq R}\\
        \overleftarrow{\Gamma}=\cbraces{-R+iy}{y\in[0,2]},\quad\overrightarrow{\Gamma}=\cbraces{R+iy}{y\in[0,2]}.
    \end{gather*}
    ...
    By equation~\eqref{eq:residueatpole}, we have \[\Res[f,\frac{i}{2}]=\lim_{z\to\frac{i}{2}}\qty(z-\frac{i}{2})\frac{\exp(-2\pi iz\xi)}{\cosh(\pi z)}\]
\end{proof}
