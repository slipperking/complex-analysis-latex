...
\begin{proof}
    ...
    Therefore, from the first two integrals, \(f\paren{z+\varepsilon'e^{it}}\) has constant argument. From the equality of the last two integrals, \(\int_{0}^{2\pi}\brackets{\abs{f\paren{z+\varepsilon'e^{it}}-\abs{f(z)}}}=0\)
\end{proof}
