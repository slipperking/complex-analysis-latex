...
In normal calculus, we worked with functions $f: \mathbb{R}\to\mathbb R$. In complex analysis the focus is functions of the form $f: \mathbb C\to\mathbb C$. The criteria for functions to be \textit{analytic} is that the direction of which 
\end{document}
