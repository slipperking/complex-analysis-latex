...
Let \(f(z)\in \Aut\qty(\riemannsphere)\) such that \(f(\infty)=\infty\). It follows that \(f\) maps \(\mathbb{C}\) to \(\mathbb{C}\) bijectively and \(\Aut(\mathbb{C})\subset\Aut\qty(\riemannsphere)\). 

Let \(f(z)\in\Aut\qty(\riemannsphere)\) such that \(f(\infty)\neq\infty\). Then, \(g(z)=\frac{1}{f(z)-f(\infty)}\in\Aut\qty(\riemannsphere)\). By the property above, 
