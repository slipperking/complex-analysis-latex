...
For the purpose of notation, we will define \(\mathbb{H}^+=\cbraces{z\in\mathbb{C}}{\Im(z)>0}\) and define \(\overline{\mathbb{H}^+}=\mathbb{H}^+\cup\mathbb{R}\).
...
\begin{proof}
    ...
    \begin{gather*}
        \int_{\partial D(z,\varepsilon)}\frac{f(\zeta)\ddzeta}{\zeta-z}=\int_0^{2\pi}\frac{f\paren{z+\varepsilon \ee^{\ii t}}}{\varepsilon \ee^{\ii t}}\cdot i\varepsilon \ee^{\ii t}\dd{t}=i\int_0^{2\pi}f(z+\varepsilon \ee^{\ii t})\dd{t}\\
        =\ii\int_0^{2\pi}\left(f\paren{z+\varepsilon \ee^{\ii t}}-f(z)\right)\dd{t}+\ii\int_0^{2\pi}f(z)\dd{t}.
    \end{gather*}
    Because \(f\in C^1\left(\overline{U}\right)\), by \autoref{lemma:c1lipschitz}, \(f\) is Lipschitz continuous on \(\overline{U}\), and \(\exists M\in\mathbb{R}_{>0}\) such that \(\forall z_0,z_1\in\overline{U}\), \(\abs{f\paren{z_1}-f\paren{z_0}}\le M\abs{z_1-z_0}\). On \(\partial D(z,\varepsilon)\), we get that \(\abs{f(z+\varepsilon \ee^{\iit})-f(z)}\leq M\varepsilon\). Therefore, \[\abs{\int_0^{2\pi}\left(f\paren{z+\varepsilon \ee^{\ii t}}-f(z)\right)\dd{t}}\leq\int_0^{2\pi}\abs{f\paren{z+\varepsilon \ee^{\ii t}}-f(z)}\dd{t}\leq 2M\pi\varepsilon,\] which approaches 0 as \(\varepsilon\to0\). Taking this limit, we obtain
    \begin{equation}
...
Since \(\ddzeta=\ii R\ee^{\ii\tau}\dd{\tau}\), \(\dd{\tau}=\frac{\ddzeta}{i\zeta}\), and \[u(z)=\frac{1}{2\pi\ii}\int_{\partial D(0,R)}\frac{u(\zeta)}{\zeta}\Re\qty(\frac{\zeta+z}{\zeta-z})\ddzeta=\Re\qty[\frac{1}{2\pi\ii}\int_{\partial D(0,R)}\frac{u(\zeta)}{\zeta}\frac{\zeta+z}{\zeta-z}\ddzeta],\]
where \(z\in D(0,R)\). Since \(R>0\) and \(\zeta-z\neq0\), the function \(\frac{1}{2\pi\ii}\int_{\partial D(0,R)}\frac{u(\zeta)}{\zeta}\frac{\zeta+z}{\zeta-z}\ddzeta\) is holomorphic on \(D(0,R)\). Therefore, \(u(z)\) is the real part of a holomorphic function \(f(z)=\frac{1}{2\pi\ii}\int_{\partial D(0,R)}\frac{u(\zeta)}{\zeta}\frac{\zeta+z}{\zeta-z}\ddzeta+ic\), where \(c\in\mathbb{R}\). Since \(c\in\mathbb{R}\) is holomorphic, by \autoref{lemma:realvaluedholomorphicfunctionconstant}, \(c\) is constant. For \(f(z)=u(z)+iv(z)\),
\begin{equation}
...
\end{gather}
Since \(u\qty(z)\) is continuous on \(\partial\mathbb{D}\) and \(u\circ\exp(i\theta)\) is periodic with period \(2\pi\), it admits a Fourier series representation
\begin{equation}
    u\qty(\ee^{\ii\theta})\sim\sum_{n=-\infty}^\infty a_n \ee^{\iin\theta},\qquad a_n=\frac{1}{2\pi}\int_0^{2\pi} u\qty(\ee^{\ii\tau})\ee^{-in\tau}\dd{\tau}. \label{eq:poissonintegralformulafourierseries}
\end{equation}
...
\[\sum_{n=-\infty}^\infty a_n \ee^{\iin\theta}\rho^{\abs{n}}, \quad\abs{\sum_{n=-\infty}^\infty a_n \ee^{\iin\theta}\rho^{\abs{n}}}\leq\sum_{n=-\infty}^\infty\abs{a_n}\rho^{\abs{n}}\leq M \frac{1+\abs{\rho}}{1-\abs{\rho}}.\]
Substituting the coefficients gives
\begin{align*}
    \sum_{n=-\infty}^\infty a_n \ee^{\iin\theta}\rho^{\abs{n}}&=\sum_{n=-\infty}^\infty \qty(\frac{1}{2\pi}\int_0^{2\pi}u\qty(\ee^{\ii\tau})\ee^{-in\tau}\dd{\tau}) \ee^{\iin\theta}\rho^{\abs{n}}\\
    &=\frac{1}{2\pi} \sum_{n=-\infty}^\infty \int_0^{2\pi}\rho^{\abs{n}} u\qty(\ee^{\ii\tau}) \ee^{\iin(\theta-\tau)}\dd{\tau}.
\end{align*}
By the Weierstrass \(M\)-Test (\autoref{thm:weierstrassmtest}) and \autoref{thm:limitintegralswitch},
\begin{equation}
    \frac{1}{2\pi}\sum_{n=-\infty}^\infty \int_0^{2\pi} \rho^{\abs{n}}u\qty(\ee^{\ii\tau}) \ee^{\iin(\theta-\tau)} \dd{\tau}=\frac{1}{2\pi} \int_0^{2\pi} u\qty(\ee^{\ii\tau})\sum_{n=-\infty}^\infty \rho^{\abs{n}} \ee^{\iin(\theta-\tau)}\dd{\tau}.\label{eq:poissonintegralformulafourierseriespostintegralsummationswitch}
\end{equation}
The summation simplifies as follows:
\begin{align*}
    \sum_{n=-\infty}^\infty \rho^{\abs{n}} \ee^{\iin(\theta-\tau)}&=\sum_{n=0}^\infty \rho^n \ee^{\iin(\theta-\tau)}+\sum_{n=1}^\infty \rho^n \ee^{-in(\theta-\tau)}\\
    &=1+2\sum_{n=1}^\infty\rho^n\cos[n(\theta-\tau)]\\
    &=1+2\Re\sum_{n=1}^\infty\rho^n \ee^{\iin(\theta-\tau)} \\
...
\[\sum_{n=-\infty}^\infty a_n \ee^{\iin\theta}\rho^{\abs{n}}=\frac{1}{2\pi}\int_0^{2\pi}\frac{\qty(1-\rho^2)u\qty(\ee^{\ii\tau})}{1+\rho^2-2\rho\cos(\theta-\tau)}\dd{\tau}=u\qty(\rho \ee^{\ii\theta}).\]
...
\[\lim_{\rho\to1^-}\sum_{n=-\infty}^\infty a_n \ee^{\iin\theta}\rho^{\abs{n}}=u\qty(\ee^{\ii\theta}).\]
...
\begin{theorem}\label{thm:meanvaluepropertysolutionsareharmonic}
    ...
    \[f(z_0)=\frac{1}{2\pi}\int_0^{2\pi} f\qty(z_0+\varepsilon \ee^{\iit})\dd{t}.\]
...
\begin{proof}
    ...
    \begin{equation}
        f(z)=\frac{1}{2\pi\ii}\qty(\sum_{n=0}^\infty\int_{\gamma_2}\frac{(z-a)^n}{(\zeta-a)^{n+1}}f(\zeta)\ddzeta+\sum_{n=1}^\infty\int_{\gamma_1}\frac{(\zeta-a)^{n-1}}{(z-a)^{n}}f(\zeta)\ddzeta).\label{eq:laurentexpansionofholomorphicfunction_finalstep}
    \end{equation}
...
\begin{proof}
    ...
    \end{figure}Consider \(\gamma\) to be a closed semicircle with radius \(R\geq 2\) as in \autoref{fig:semicircularcontour}. Notice that the function \(z\mapsto\frac{1}{\qty(z^2+1)^{n+1}}\) has singularities at only \(z=i\) and \(z=-i\), both of which are poles of order \(n+1\). By equation~\eqref{eq:residueatpole}, the residue at \(z=i\) is
    \begin{align*}
        \residue_{z=i}\frac{1}{\qty(z^2+1)^{n+1}} & =\left.\frac{1}{n!}\dv[n]{z}\qty((z+i)^{-n-1})\right|_{z=i}=\frac{1}{n!}\frac{(-1)^n\prod_{k=1}^n (n+k)}{(2i)^{2n+1}} \\
        & =\frac{(-1)^n(2n)!}{(n!)^2(2i)^{2n+1}}=\frac{(2n!)}{i2^{2n+1}(n!)^2}.
    \end{align*}
    The singularity at \(z=-i\) is not relevant, as it is not enclosed by the contour. By the Residue Theorem (\autoref{thm:residuethm}), we have
    \begin{align*}
        \int_{\gamma} \frac{1}{\qty(z^2+1)^{n+1}}\ddz & =\int_{-R}^R\frac{1}{\qty(x^2+1)^{n+1}}\ddx+\int_0^\pi\frac{Ri}{\qty(R^2e^{2i\theta}+1)^{n+1}}\ee^{\ii\theta}\dd{\theta} \\
        & =2\pi\ii\cdot\residue_{z=i}\frac{1}{\qty(z^2+1)^{n+1}}=\frac{(2n)!\pi}{2^{2n}(n!)^2}.
    \end{align*}
    We will now show that the integral over the semicircle vanishes as \(R\to\infty\). Under the assumption that \(R\geq 2\), since \[\abs{\frac{Rie^{i\theta}}{\qty(R^2e^{2i\theta}+1)^{n+1}}}=\frac{R}{\abs{R^2e^{2i\theta}+1}^{n+1}}\leq\frac{R}{\abs{R^2-1}}\leq\frac{2}{3},\] which is integrable over \([0,\pi]\), and we can commute the limit with the integral. Therefore, we have \[\int_{-\infty}^\infty \frac{1}{\qty(x^2+1)^{n+1}}\ddx=\lim_{R\to\infty}\int_{\gamma}\frac{1}{\qty(z^2+1)^{n+1}}\ddz-\int_0^{\pi}\lim_{R\to\infty}\frac{Ri}{\qty(R^2\ee^{2i\theta}+1)^{n+1}}\ee^{\ii\theta}\dd{\theta}=\frac{(2n)!\pi}{2^{2n}(n!)^2}.\]
\end{proof}
...
\begin{proof}
    ...
    We will now analyze each integral. The first integral is \[\int_{C_R}f(z)\ddz=\int_0^\pi\frac{\exp(iR\ee^{\ii\theta})}{R\ee^{\ii\theta}}Ri\ee^{\ii\theta}\dd{\theta}=i\int_0^{\pi}\ee^{\iiR\cos\theta}\ee^{-R\sin\theta}\dd{\theta}.\]
    Notice that \(\frac{2}{\pi}\theta\leq\sin(\theta)\leq\theta\) over the integration range. We want to observe the behavior as \(R\to\infty\):
    \begin{align*}
        \abs{i\int_0^\pi \ee^{\iiR\cos\theta}\ee^{-R\sin\theta}\dd{\theta}} & \leq\int_0^{\pi}\ee^{-R\sin\theta}\dd{\theta}=2\int_0^{\frac{\pi}{2}}\ee^{-R\sin\theta}\dd{\theta}                                                                  \\
    ...
    \[\lim_{\varepsilon\to 0}\int_{C_\varepsilon}f(z)\ddz=i\int_{\pi}^0\lim_{\varepsilon\to 0^+}\ee^{-\varepsilon\sin\theta}\ee^{\ii\varepsilon\cos\theta}\dd{\theta}=i\int_{\pi}^0\dd{\theta}=-i\pi.\]
...
\begin{proof}
    ...
    \end{figure}Let \(f(z)=\ee^{\iiz^2}\). Choose the wedge contour composed of \[\Gamma_1=\cbraces{r\in\mathbb{R}}{0\leq r\leq R},\quad\Gamma_2=\cbraces{r\ee^{\ii\frac{\pi}{4}}}{0\leq r\leq R},\quad C_R=\cbraces{R\ee^{\ii\theta}}{0\leq\theta\leq\frac{\pi}{4}}\] as in \autoref{fig:wedgecontour}. By the Cauchy--Goursat Integral Theorem (\autoref{thm:cauchygoursattheorem}), we have that
    \begin{equation}
...
\begin{proof}
    ...
    where \(R>1\). By the Residue Theorem (\autoref{thm:residuethm}), we get that \[\lim_{R\to\infty}\int_{\Gamma_1}f(z)\ddz+\int_{\Gamma_2}f(z)\ddz+\int_{C_R}f(z)\ddz=2\pi\ii\Res[f,\exp(i\frac{\pi}{\beta})].\]
    By equation~\eqref{eq:residueatpole}, it follows that
    \begin{align*}
        \residue\qty[f,\exp(i\frac{\pi}{\beta})]&=\lim_{z\to\exp(i\frac{\pi}{\beta})}\flatfrac{\qty[z-\exp(i\frac{\pi}{\beta})]}{\qty[\frac{1+z^\beta}{z^\alpha}]}\\
        &=\lim_{z\to\exp(i\frac{\pi}{\beta})}{\dv{z}(z^{-\alpha}+z^{\beta-\alpha})}^{-1}\\
        &=\lim_{z\to\exp(\ii\frac{\pi}{\beta})}\frac{z^{\alpha+1}}{(\beta-\alpha)z^{\beta}-\alpha}\\
        &=-\frac{1}{\beta}\exp(\ii\frac{\pi}{\beta}(\alpha+1)).
    \end{align*}
    We can write the integral on \(\Gamma_2\) in terms of \(I\): \[\int_{\Gamma_2}f(z)\ddz=\int_R^0 f\qty[r\exp(\ii\frac{2\pi}{\beta})]\exp(i\frac{2\pi}{\beta})\dd{r}=-\exp[i\frac{2\pi}{\beta}(1+\alpha)]\int_0^R\frac{r^\alpha}{1+r^\beta}\dd{r}.\]
    ...
    \[\abs{\int_0^{\frac{2\pi}{\beta}}\frac{R^{\alpha+1}}{1+R^\beta \ee^{\ii\beta\theta}}\exp[i\theta(1+\alpha)]\dd{\theta}}\leq\int_0^{\frac{2\pi}{\beta}}\frac{R^{\alpha+1}}{R^\beta-1}\dd{\theta}.\]
...
\begin{proof}
    ...
    They can be bounded with \[\abs{\int_0^1 \frac{\exp(-2\pi\ii(R+iz)\xi)}{\cosh(\pi(R+iz))}\ddz}\leq 2\int_0^1\frac{\exp(2\pi z\xi)}{\abs{\ee^{\pi R}\ee^{\pi iz}+\ee^{-\pi R}\ee^{-\pi iz}}}\ddz\leq2\int_0^1\frac{\exp(2\pi z\xi)}{\abs{\ee^{\pi R}-\ee^{-\pi R}}}\ddz\] and \[\abs{\int_1^0 \frac{\exp(2\pi\ii(R-iz)\xi)}{\cosh(\pi(-R+iz))}\ddz}\leq 2\int_0^1\frac{\exp(2\pi z\xi)}{\abs{\ee^{-\pi R}\ee^{\pi \ii z}+\ee^{\pi R}\ee^{-\pi \ii z}}}\ddz\leq2\int_0^1\frac{\exp(2\pi z\xi)}{\abs{\ee^{\pi R}-\ee^{-\pi R}}}\ddz\]
...
\end{equation} where \(z\in\mathbb{C}\). By letting \(z=x+iy\) where \(x,y\in\mathbb{R}\), we have \(\abs{\ee^{-t}t^{z-1}}=\ee^{-t}t^{x-1}\). Notice that for \(x>0\),
\begin{align*}
...
\begin{align*}
    ...
    &=\frac{n^z n!}{\prod_{k=0}^n(z+k)}.
\end{align*}
Let us now analyze the difference \[\lim_{n\to\infty}\qty[\int_0^n \ee^{-t}t^{z-1}\ddt-f_n(z)]=\lim_{n\to\infty}\int_0^n \ee^{-t}t^{z-1}\qty[1-\ee^{t}{\qty(1-\frac{t}{n})}^n]\ddt.\]
Since \[\dv{t}(\ee^t{\qty(1-\frac{t}{n})}^n)=\ee^t
\qty(1-\frac{t}{n})^n-\ee^t\qty(1-\frac{t}{n})^{n-1}=-\ee^t\frac{t}{n}{\qty(1-\frac{t}{n})}^{n-1},\]
we have \[1-\ee^t\qty(1-\frac{t}{n})^n=\frac{1}{n}\int_0^t u\ee^u\qty(1-\frac{u}{n})^{n-1}\dd{u}\]
Additionally, since \[\dv{u}(\ee^u\qty(1-\frac{u}{n})^{n-1})=\ee^u\qty(1-\frac{u}{n})^{n-1}-\frac{n-1}{n}\ee^u\qty(1-\frac{u}{n})^{n-2}=\frac{\ee^u}{n}\qty(1-\frac{u}{n})^{n-2}\qty(1-u)\] has zeros at \(u=1\) and at \(u=n\), and \[\dv[2]{u}(\ee^u\qty(1-\frac{u}{n})^{n-1})=\frac{\ee^u}{n^2}\qty(1-\frac{u}{n})^{n-3}\qty(u^{2}-2u-n+2),\] which evaluates to \(-\frac{\ee(n-1)^{n-2}}{n^{n-1}}<0\) at \(u=1\) and evaluates to \(\frac{\ee^n}{n^{n-1}}\qty(n-u)^{n-3}(n-2)(n-1)\to0^+\) as \(u\to n^-\). Therefore, \(\ee^u{\qty(1-\frac{u}{n})}^{n-1}\) attains its maximum of \(\ee{\qty(\frac{n-1}{n})}^{n-1}\) at \(u=1\).
\end{document}
