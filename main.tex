...
Then,
\[\phi(z)=\frac{1}{2\pi}\int_0^{2\pi}\phi\qty(Re^{i\tau})\frac{R^2-\abs{z}^2}{\abs{Re^{i\tau}-z}^2}\dd{\tau}.\]
The expression \(P(\zeta,z)=\frac{R^2-\abs{z}^2}{2\pi\abs{\zeta-z}^2}\) is the gener
