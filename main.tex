...
\end{definition}
It then follows that the residue at a removable singularity is 0. Let \(z=\infty\) be an isolated singularity of \(f(z)\), which is holomorphic in \(\mathbb{C}\setminus\overline{D(0,R)}\), for sufficiently large finite \(R\). Then for finite \(\rho>R\), the residue at \(z=\infty\) is \textit{defined} as \[\residue_{z=\infty}f(z)=-\frac{1}{2\pi i}\int_{\partial D(0,\rho)}f(z)\ddz.\]
Let \(\zeta=\frac{1}{z}\). Then we get that \[\residue_{z=\infty}f(z)=-\frac{1}{2\pi i}\int_{|\zeta|=\frac{1}{\rho}}f\qty(\frac{1}{\zeta})\dd(\frac{1}{\zeta})=\frac{1}{2\pi i}\int_{\partial D\qty(0,\frac{1}{\rho})}\frac{f\qty(\frac{1}{\zeta})}{\zeta^2}\ddzeta=\Res_{\zeta=0}\frac{f\qty(\frac{1}{\zeta})}{\zeta^2}.\]
