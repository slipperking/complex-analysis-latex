...
\end{definition}
Similar to holomorphy, meromorphy on a compact set can be defined as meromorphy on a neighborhood of the set. In general, we imply for the set to be open unless stated otherwise.

All holomorphic functions are meromorphic functions (with poles on \(\emptyset\)). All 
