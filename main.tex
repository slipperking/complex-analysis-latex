...
\usepackage{parskip}
\usepackage{tikz}
\usetikzlibrary{decorations.markings, calc, arrows.meta, hobby}
...
\begin{proof}
    \begin{figure}
        ...
        \begin{tikzpicture}[>=stealth,
            ...
            \pgfmathsetmacro{\eta}{14pt}
            \pgfmathsetmacro{\varepsilon}{11pt}

            \coordinate (M) at (1, 1);
            \coordinate (P) at (1, 3.5);
            \coordinate (Q) at (5, 3.7);
            \coordinate (N) at (5, 1.2);
            \coordinate (Mprime) at ([yshift=\eta] M);
            \coordinate (Pprime) at ([yshift=-\eta] P);
            \coordinate (Qprime) at ([yshift=-\eta] Q);
            \coordinate (Nprime) at ([yshift=\eta] N);
            
            \draw[-{Stealth}, thick] (-0.5, 0) -- (6, 0);
            \draw[-{Stealth}, thick] (0, -0.5) -- (0, 6);

            \draw[thick, arrow style] (P) -- (M);
            \draw[thick, arrow style] (Q) to[out angle=90, in angle=90, curve through = {([shift={(2, 0)}] P) ([shift={(1.5, 0.2)}] P)}] (P);
            \draw[thick, arrow style] (N) -- (Q);
            \draw[thick, arrow style] (M) to[out angle=270, in angle=270, curve through = {([shift={(-2, 0)}] N) ([shift={(-1.5, -0.2)}] N)}] (N);

            \draw[thin, arrow style] (Mprime) to[out angle=270, in angle=270, curve through = {([shift={(-2, 0)}] Nprime) ([shift={(-1.5, -0.2)}] Nprime)}] (Nprime);
            \draw[thin, arrow style] (Qprime) to[out angle=90, in angle=90, curve through = {([shift={(2, 0)}] Pprime) ([shift={(1.5, 0.2)}] Pprime)}] (Pprime);

            \path let \p1 = (M) in coordinate (Leftxint) at (\x1, 0);
            \draw[dashed] (M) -- (Leftxint);
            \path let \p1 = (N) in coordinate (Rightxint) at (\x1, 0);
            \draw[dashed] (N) -- (Rightxint);
            ...
            \node[anchor=north] at (Leftxint) {\(a\)};
            \node[anchor=north] at (Rightxint) {\(b\)};
