...
\end{theorem}
The above theorem is only a specifi
...
\begin{theorem}[Green's Theorem]\label{thm:complexgreen}
...
\begin{proof}
    ...
    with a singularity at \(\zeta=z\). Consider the region \(U\setminus D(z,\varepsilon)\). Applying the Stokes--Cartan Theorem (\autoref{thm:stokescartan}), \begin{equation}
