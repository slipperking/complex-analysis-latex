...
\begin{proof}
    ...
    \begin{gather*}
        \overset{\uparrow}{\Gamma}=\cbraces{x+2i}{-R\leq x\leq R,x\in\mathbb{R}},\qquad\overset{\downarrow}{\Gamma}=\cbraces{x\in\mathbb{R}}{-R\leq x\leq R}\\
        \overleftarrow{\Gamma}=\cbraces{-R+iy}{y\in[0,2]},\qquad\overrightarrow{\Gamma}=\cbraces{R+iy}{y\in[0,2]}.
    \end{gather*}
