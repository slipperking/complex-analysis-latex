...
For \(U\subseteq \mathbb{C}\) and a complex function $f:\mathbb{U}\to\mathbb{C}$, $f(z)$ is differentiable at \(z\in U\) if the following limit exists, regardless of the direction \(h\) approaches 0 at:
