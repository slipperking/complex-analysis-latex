    ...
    \item The existence of a transcendental meromorphic function \(f\) whose poles have an accumulation point at \(z=\infty\) is the concern of the following theorem:
        ...
        \begin{proof}
            ...
            \begin{enumerate}[label=(\alph*)]
                ...
                By the convergence of \(\sum_{n=N+1}^\infty\varepsilon_n\), by the Weierstrass \(M\)--Test (\autoref{thm:weierstrassmtest}), the series \(\sum_{n=N+1}^\infty\abs{\psi_n(z)-p_n(z)}\) converges uniformly on \(D(0,R)\). 
            \end{enumerate}
        \end{proof}
\end{enumerate}
