...
\begin{proof}
    ...
    As \(R\to\infty\), this integral tends to 0. Let \(z=re^{i\frac{\pi}{4}}\) on \(\gamma_2\). Then, we have \[\int_{\gamma_2}f(z)\ddz=\int_0^R e^{i\qty(re^{i\frac{\pi}{4}})^2}e^{i\frac{\pi}{4}}\dd{r}=\int_0^R.\]
\end{proof}
