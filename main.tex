...
\end{example}
\begin{proof}
    First assume \(z\in\overline{\mathbb{R}}=\mathbb{R}\cup\qty{\infty}\). It follows that \[\abs{w}=\abs{\ee^{\ii\theta}\frac{z-a}{z-\overline{a}}}=1.\] Therefore, this transformation maps \(\overline{\mathbb{R}}\) to \(\partial\mathbb{D}\). The inverse mapping is equal to \[z=\frac{w\overline{a}-a\ee^{\ii\theta}}{w-\ee^{\ii\theta}}.\]
    ...
    Let \(\psi(z)\) be the biholomorphism from \(\mathbb{H}^+\) to \(\mathbb{D}\) in the form of \(\psi(z)=\ee^{\ii\theta}\frac{z-a}{z-\overline{a}}\). Let \(f\) be an arbitrary biholomorphism from \(\mathbb{H}^+\) to \(\mathbb{D}\). It follows that \(\varphi=f\circ\psi^{-1}\) is a holomorphic automorphism of \(\mathbb{D}\). Since \(\varphi\in\Aut(\mathbb{D})\), we have \[f(z)=\varphi\circ\psi(z)=\ee^{\ii\vartheta}\frac{\ee^{\ii\theta}\frac{z-a}{1-\overline{a}z}-a}{1-\overline{a}\ee^{\ii\theta}\frac{z-a}{1-\overline{a}z}}\]
\end{proof}
