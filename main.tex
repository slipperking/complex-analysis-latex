...
It is common knowledge in algebra that any polynomial can be factored into linear factors. In complex analysis, we can extend this to entire and meromorphic functions. 

Before we explain the Weierstrass Factorization Theorem, we will first introduce the concept of infinite products. 
...
\begin{figure}
\centerline{\includesvg[width=0.75\linewidth, inkscapelatex=false]{riemannsphere.svg}}
