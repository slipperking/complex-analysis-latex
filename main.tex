...
\begin{proof}
    We will prove that the value in equation \eqref{eq:cauchyhadamard} satisfies the criteria in \autoref{abels}

    Assume \(\abs{z}<R\). Then \(\forall\rho\in(|z|,R)\), \(\frac{1}{\rho}>\frac{1}{R}\), 
\end{proof}
