...
\begin{proof}
    ...
    \end{gather*} Because $f\in C^1\left(\overline{U}\right)$, by \autoref{lemma:c1lipschitz}, 
    By combining and rearranging, we take the limit as \(\varepsilon\to0\): \[i\lim_{\varepsilon\to0}\int_0^{2\pi}f(z+\varepsilon e^{it})\dd{t}=\int_U\frac{f(\zeta)\ddzeta}{\zeta-z}-\int_{U\setminus D(z,\varepsilon)}\pdv{f}{\overline{\zeta}}\cdot\frac{f(\zeta)}{\zeta-z}\dd{\overline{\zeta}}\wedge\ddzeta.\] 
\end{proof}
\end{document}