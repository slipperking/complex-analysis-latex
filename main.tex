...
\end{proof}
The property of local finiteness of a collection \(\mathfrak{B}\) in \(\Omega\) is commonly stated as: \(\forall z\in\Omega\), there exists an open neighborhood of \(z\) intersecting finitely many sets in \mathfrak{B}
