...
\begin{theorem}\label{thm:identityaccumulationofzeroes}
    Let \(U\subseteq\mathbb{C}\), and \(f:U\to\mathbb{C}\) be holomorphic over \(U\). Then \(f\equiv0\) over \(U\) if the set \(\cbraces{z\in U\mid f(z)=0}\) has accumulation points in \(U\).
\end{theorem}
\begin{proof}
