...
\begin{proof}
    ...
    \end{gather*}
    The enclosed singularities are simple poles at \(z=\frac{i}{2},\frac{3i}{2}\) (they are simple by evaluation of the Taylor expansions of the denominator). By the Residue Theorem (\autoref{thm:residuethm}), we get that \[\qty(\int_{\overset{\uparrow}{\Gamma}}+\int_{\overset{\downarrow}{\Gamma}}+\int_{\overleftarrow{\Gamma}}+\int_{\overrightarrow{\Gamma}})f(z)\ddz=2\pi i\qty(\Res[f,\frac{i}{2}]+\Res[f,\frac{3i}{2}]).\]
