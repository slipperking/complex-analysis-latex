...
\begin{proof}
    \begin{figure}
        ...
        \begin{tikzpicture}[>=stealth,
            ...
            \node[anchor=west] at (0.65,0.4) {\(\tfrac{\pi}{4}\)};
        \end{tikzpicture}
        \caption{A wedge contour with orientation marked.}\label{fig:wedgecontour}
    \end{figure}Let \(f(z)=e^{iz^2}\). Choose the wedge contour composed of \[\gamma_1=\cbraces{z\in\mathbb{R}}{0\leq z\leq R},\quad\gamma_2=\cbraces{ze^{i\frac{\pi}{4}}}{0\leq z\leq R},\quad\gamma_3=\cbraces{Re^{i\theta}}{0\leq\theta\leq\frac{\pi}{4}}\] as in \autoref{fig:wedgecontour}. By the Cauchy--Goursat Integral Theorem (\autoref{thm:cauchygoursattheorem}), we have that \[\int_{\gamma_1}f(z)\ddz+\int_{\gamma_2}f(z)\ddz+\int_{\gamma_3}f(z)\ddz=0.\] The third integral can be written as \[\int_{\gamma_3}f(z)\ddz=Ri\int_0^{\frac{\pi}{4}}e^{i{\qty(Re^{i\theta})}^2}e^{i\theta}\dd{\theta}.\]
