...
\begin{proof}
    ...
    Then \(\abs{f_n(z)}>\var\frac{\varepsilon}{2}\) on \(\gamma\). It follows that \(\frac{1}{f_n(z)}\) and its limit are uniformly bounded: \[\abs{\frac{1}{f(z)}}<\frac{1}{\varepsilon},\quad\abs{\frac{1}{f_n(z)}}<\frac{2}{\varepsilon},\quad\forall z\in\gamma,\forall n>N.\]
    Then,
    \begin{align*}
