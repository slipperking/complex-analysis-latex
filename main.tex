...
\begin{theorem}[Hurwitz's Theorem]\label{thm:hurwitz}
    ...
    Then, for any compact set \(K\subset U\), and any neighborhood \(V\) of the set \(\cbraces{z\in K}{f(z)=0}\), \(\exists N\in\mathbb{N}\) such that \(\forall n>N\), \(\cbraces{z\in K}{f_n(z)=0}\subset V\), and the number of zeroes in \(K\)
\end{theorem}
