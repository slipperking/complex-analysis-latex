...
\begin{proof}
    ...
    where \(\abs{\Delta z}=\sqrt{{\Delta x}^2+{\Delta y}^2}\) and \(o_1\paren{\abs{\Delta z}}\) and \(o_2\paren{\abs{\Delta z}}\) are functions that are of higher infinitesimal order to \(\Delta z\), satisfying \(\lim_{\Delta z\to0}\frac{o_1\paren{\Delta z}}{\Delta z}=0\) and \(\lim_{\Delta z\to0}\frac{o_2\paren{\Delta z}}{\Delta z}=0\). Then letting \(\Delta z=x-x_0+i\paren{y-y_0}\),
    \[f\paren{z}-f\paren{z_0}=\alpha{\Delta z}+i\beta{\Delta z}+o_1\paren{\abs{\Delta z}}+o_2\paren{\abs{\Delta z}},\]
    \[\frac{f\paren{z}-f\paren{z_0}}{\Delta z}=\alpha+\beta+\frac{o_1\paren{\Delta z}}{\Delta z}+\frac{o_2\paren{\Delta z}}{\Delta z}.\]
\end{proof}
