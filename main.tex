...
\begin{proof}
	...
	\end{align*}
	The integral on \(\gamma_\varepsilon\) also vanishes similarly:
	\begin{align*}
		\int_{\gamma_\varepsilon}f(z)\ddz&=\int_0^\pi\frac{\exp(i\varepsilon e^{i\theta})}{\varepsilon e^{i\theta}}\varepsilon ie^{i\theta}\dd{\theta}=i\int_0^\pi e^{i\varepsilon\cos\theta}e^{-\varepsilon\sin\theta}\dd{\theta}
	\end{align*}
\end{proof}
