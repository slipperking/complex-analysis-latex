...
\begin{proof}
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \coordinate (M) at (1, 1);
            \coordinate (P) at (1, 5);
            \coordinate (Q) at (5, 4.5);
            \coordinate (N) at (5, 2);

            \draw[thick, orientation indication] (M) -- (P);
            \draw[thick, orientation indication] (P) to[out angle=90, in angle=90, curve through = {([shift={(1, 0.5)}] P) ([shift={(2, 0)}] P)}] (Q);
            \draw[thick, orientation indication] (Q) -- (N);
            \draw[thick, orientation indication] (M) to[out angle=270, in angle=270, curve through = {([shift={(1, 0.2)}] M) ([shift={(2, 0)}] M)}] (N);
        \end{tikzpicture}
        \caption{}
