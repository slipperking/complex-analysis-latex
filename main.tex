    ...
    \item The existence of a transcendental meromorphic function \(f\) whose poles have an accumulation point at \(z=\infty\) is the concern of the following theorem:
        ...
        \begin{proof}
            ...
            \begin{enumerate}[label=(\alph*)]
                ...
                \item Let \(\qty{\varepsilon_n}_{n\in\mathbb{N}}\) be a positive sequence such that \(\sum_{n=1}^\infty\varepsilon_n\) is convergent. If \(a_1=0\), we can choose \(p_1(z)=0\) (this can actually be any arbitrary polynomial). For \(n\geq 2\) (or \(n\geq 1\) if \(a_1\) is nonzero), \(\psi_n\) is a polynomial in terms of \(\frac{1}{z-a_n}\). 
            \end{enumerate}
        \end{proof}
\end{enumerate}
