...
\end{theorem}
In 3 dimensional $\mathbb{R}^3$ space, define a scalar valued function to be a 0-form, a linear combination of \(\ddx\), \(\dv{y}\), and \(\dd{z}\) to be a 1-form, Green's, Stokes', and Gauss' Theorems can be generalized into:
