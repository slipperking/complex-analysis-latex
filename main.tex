...
\begin{proof}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \node[anchor=south] at ($(0,0)!0.5!(zeta)$) {\(R\)};
    ...
    where \(\zeta=Re^{i\tau}\) and \(z=\rho e^{i\theta}\), assume that \(\abs{\vartheta-\tau}>\delta\). Then \(\exists\eta>0\) such that when \(|\xi-z|<\eta\), \(\abs{\theta-\tau}>\delta\) and \(\rho>\frac{R}{2}\). Then by the Law of Cosines, \(|\zeta-z|^2>R^2+\rho^2-2R\rho\cos(\delta)\). 
\end{proof}
