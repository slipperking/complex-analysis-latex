...
\begin{proof}
    ...
    Since \(\abs{\varphi\qty(Re^{i\vartheta})-\varphi(\zeta)}<2M\), we want \(\int_{\abs{\vartheta-\tau}>\delta}\frac{R^2-\rho^2}{\pi R^2\qty(1-\cos(\delta))}\dd{\tau}<2\frac{R^2-\rho^2}{R^2\qty(1-\cos(\delta))}< \frac{\varepsilon}{2M}\), and \[R^2-\rho^2<\frac{\varepsilon}{4M}R^2\paren{1-\cos(\delta)}\Rightarrow R-\rho<\frac{\varepsilon}{6M}R\paren{1-\cos(\delta)}.\]
