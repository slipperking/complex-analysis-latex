...
\begin{proof}
    ...
    \[k_f-k_g=\int_{\gamma}\frac{f'(z)}{f(z)}\ddz-\int_\gamma\frac{g'(z)}{g(z)}\ddz=\int_\gamma\frac{f'(z)g(z)-g'(z)f(z)}{f(z)g(z)}\ddz=\int_\gamma\frac{\paren{\frac{f(z)}{g(z)}}'}{\frac{f(z)}{g(z)}}\ddz.\]
