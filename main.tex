...
Therefore, there exists a one-to-one correspondence between \(\Aut\qty(\riemannsphere)\) and the group (under matrix multiplication) of \[\left.\cbraces{\mqty(a&b\\c&d)}{\det{\mqty(a&b\\c&d)}=1}/\qty{\pm I},\]
