...
Lastly, we will examine the power function. Let \(\alpha=u+iv\). Then, \[z^\alpha=e^{\alpha\log(z)}=e^{(u+iv)\paren{\ln\abs{z}+i\arg\paren{z}}}=e^{u\ln\abs{z}-v\arg\paren{z}}e^{i\paren{v\ln\abs{z}+u\arg{z}}}\]
