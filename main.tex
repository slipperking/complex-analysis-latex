...
\begin{proof}
    ...
    As \(R\to\infty\), this integral tends to 0. 
\end{proof}
...
\begin{proof}
    ...
    \[\lim_{\varepsilon\to 0} \varepsilon i \int_\alpha^\beta\varphi(a+\varepsilon e^{i\theta}) e^{i\theta}\dd{\theta}=\varepsilon i\int_\alpha^\beta\lim_{\varepsilon\to 0}\varphi(a+\varepsilon e^{i\theta})e^{i\theta}\dd{\theta}=0.\]
    Therefore,
