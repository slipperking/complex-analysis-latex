...
\renewcommand{\frac}[2]{%
  \mathchoice
    ...
    {\dfrac{#1}{#2}}% text style (still use display style here)
    {\frac@script{#1}{#2}}% script style (used in superscripts)
    {\frac@scriptscript{#1}{#2}}% scriptscript style (used in nested superscripts)
}
\makeatother
