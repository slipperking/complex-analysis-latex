...
\begin{proof}
	...
	Hence, 
	\begin{align*}
		\int_\pi^0\frac{e^{\varepsilon\qty(i\cos\theta-\sin\theta)}}{\varepsilon e^{i\theta}}i\varepsilon e^{i\theta}\dd{\theta}&=-2\pi i-\int_{0}^{-\pi}\frac{e^{\varepsilon\qty(i\cos\theta-\sin\theta)}}{\varepsilon e^{i\theta}}i\varepsilon e^{i\theta}\dd{\theta}
	\end{align*}
\end{proof}
