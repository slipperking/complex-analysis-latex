...
\begin{proof}
    ...
    Hence, \(z\) maps \(\partial\mathbb{D}\) to \(\overline{\mathbb{R}}\), and \(w\) maps \(\overline{\mathbb{R}}\) to \(\partial\mathbb{D}\) univalently and surjectively. \(w\) is a biholomorphism from \(\mathbb{H}^+\) to \(\mathbb{D}\) by \autoref{thm:boundaryofconformalmap}. 
\end{proof}
