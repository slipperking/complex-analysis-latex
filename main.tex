...
\end{lemma}
\begin{proof}
    By the Cauchy--Goursat Integral Formula (\autoref{thm:cauchygoursatformula}), \[f(z)=\frac{1}{2\pi i}\int_{\partial D(z,\varepsilon)}\frac{f(\zeta)}{\zeta-z}\ddzeta=\frac{1}{2\pi i}\int_{\partial D(z,\varepsilon)}f\paren{z+\varepsilon e^{it}}\dd{t}\]
\end{proof}
