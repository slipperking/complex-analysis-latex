...
TO BE CONTINUED
Finally, we will demonstrate that satisfying the mean-value property is logically equivalent to being a solution to the Laplace equation. In \autoref{lemma:holomorphicmeanvalueproperty}, we showed that solutions to the Laplace equation satisfy the mean-value property. Now we will prove the converse.
