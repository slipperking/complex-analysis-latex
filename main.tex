...
\begin{proof}
    ...
    Let \(h<1\) and let \(V=\cbraces{z\in\mathbb{C}}{\inf_{\zeta\in\supp(\varphi)}|z-\zeta|<1}\). Then, \[\abs{\frac{\psi(\xi+z+h)-\psi\paren{\xi+z}}{h}}\leq M,\] and when \(\xi+z\notin V\), \[\frac{\psi(\xi+z+h)-\psi\paren{\xi+z}}{h}=0.\]
