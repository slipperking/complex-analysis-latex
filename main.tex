...
\end{lemma}
Then we can consequently define \textit{the group of holomorphic automorphisms}. If \(U\subseteq\mathbb{C}\) is connected and \(f:U\to U\) is holomorphic on \(U\) and bijective,
