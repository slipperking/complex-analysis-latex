...
\begin{proof}
    ...
    \[\oint_{\partial U}f(\zeta)\ddzeta=\int_{\partial U}\omega=\int_{U}\dd{\omega}=\int_U\pdv{f}{\overline{\zeta}}\dd{\overline{\zeta}}\wedge\ddzeta=0.\]
\end{proof}
...
\begin{align*}
    ...
    &=z\prod_{k=1}^n\qty[\qty(1+\frac{z}{k})e^{-\frac{z}{k}}]\exp\qty(z\gamma).
\end{align*}
\end{document}
