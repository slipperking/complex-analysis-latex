...
where \(0<\rho<1\). By the uniform continuity of \(\Phi\) on \(\overline{D(0,1)}\) (\autoref{lemma:uniformcontinuousovercompactset}), \(\forall\varepsilon>0\), \(\exists\delta>0\) such that \(\forall |\rho-1|<\delta\), \(\)
