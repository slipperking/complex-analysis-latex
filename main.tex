...
\[\abs{\varphi_z(\zeta)}=\abs{\frac{1}{\zeta}}\abs{\frac{z-\zeta}{\frac{1}{\zeta}-\overline{z}}}=\abs{\frac{1}{\zeta}}\abs{\frac{z-\zeta}{\frac{\overline{\zeta}}{\abs{\zeta}^2}-\overline{z}}}.\]
Therefore, the image of \(\partial D(0,1)\) lies on \(\partial D(0,1)\), and therefore \(f\) maps \(D(0,1)\) to \(D(0,1)\). We next aim to show that \(f:D(0,1)\to D(0,1)\) is bijective.
