...
Assume \(f:\mathbb{C}\to\mathbb{C}\) is an entire automorphism. Obviously, \(f(z)\) cannot be the constant function. Therefore, by Liouville's Theorem (\autoref{thm:liouville}), \(f\) is unbounded.
