...
Let \(a\in D(0,1)\) and notice that \(\varphi_a(z)=\frac{z-a}{1-\overline{a}z}\) maps \(\partial D\) to \(\partial D\) bijectively. Let \(f:D(0,1)\to\mathbb{R}\) be harmonic  and continuous on \(\overline{D(0,1)}\).
