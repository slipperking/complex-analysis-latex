...
\begin{proof}
    ...
    \begin{align*}\int_{\Delta^n}f(z)\ddz=\int_{\Delta^n}f(z)\ddz-f\paren{z_0}\int_{\Delta^n}\ddz-f'\paren{z_0}\left(\int_{\Delta^n}z\ddz-z_0\int_{\Delta^n}\ddz\right),\end{align*}
