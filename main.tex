...
\begin{proof}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \draw[dotted] (z) arc[start angle=62.35, end angle=90, radius=1.516];
    ...
    From \autoref{fig:dirichletproblemwithlaplaceequationsolution_secondintegral}, it is evident that \(R-\rho<|\xi-z|<\eta\).
