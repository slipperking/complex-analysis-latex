...
\end{theorem}
\begin{proof}
    We aim to prove three main statements of the theorem, being the continuity of \(u(z)\), the continuous differentiability of \(u(z)\), and it satisfying the differential equation \(\pdv{u(z)}{\overline}\)
\end{proof}
