...
\begin{proof}
    ...
    From \autoref{fig:dirichletproblemwithlaplaceequationsolution_secondintegral}, it is evident that \(R-\rho<|\xi-z|<\eta\). In order for \(|\theta-\tau|>\delta\) to be true, we need to ensure that \(\eta<R^2+\rho^2-2R\rho\cos(\vartheta-\tau-\delta)<\)
