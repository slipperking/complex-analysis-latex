...
\begin{proof}
    ...
    Finally, by the definition of a derivative, for a fixed \(n\), \(\exists\delta>0\) such that \(\forall z\in D\qty(z_0, \delta)\), \[\qty|\frac{S_n(z)-S_n\qty(z_0)}{z-z_0}-S'_n(z)|<\frac{\varepsilon}{3}.\]
    From equation \eqref{eq:abelradius_differentiationintermediate}, we get:
    \[\qty|\frac{f(z)-f\qty(z_0)}{z-z_0}-f_1\paren{z}|<\varepsilon,\] as desired.
\end{proof}
