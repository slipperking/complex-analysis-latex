...
\end{theorem}
\begin{proof}
    Let \(\qty{a_n}\) be the bounded sequence. In other words, \(\exists m,M\in\mathbb{R}\) such that \(\qty{a_n}\subset[m,M]\). By the infiniteness of \(\qty{a_n}\), at least one of \(\qty[m,\frac{m+M}{2}]\) and \(\qty[\frac{m+M}{2},M]\) contain an infinite subsequence. 
    
    Let \(m_1\) be the lower bound of the selected interval and \(M_1\) be the upper. Then at least one of \(\qty[m_1,\frac{m_1+M_1}{2}]\) and \(\qty[\frac{m_1+M_1}{2},M_1]\) contain an infinite subsequence.
    ...
    Let \(\mu_n\) be the length of \(\qty[m_n,M_n]\). BY the 
