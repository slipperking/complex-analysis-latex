...
\end{align*}
Substituting this into equation~\eqref{eq:poissonintegralformulafourierseriespostintegralsummationswitch}, we have that \[\sum_{n=-\infty}^\infty a_n e^{in\theta}\rho^{|n|}=\frac{1}{2\pi}\int_0^{2\pi}\frac{\qty(1-\rho^2)u\qty(e^{i\tau})}{1+\rho^2-2\rho\cos(\theta-\tau)}\dd{\tau}.\]
