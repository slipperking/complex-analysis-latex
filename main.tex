...
\begin{proof}
    ...
    Then by Morera's Theorem (\autoref{thm:morera}), \(f(z)\) is holomorphic. Then \(f'(z)\) is holomorphic. Let \(K\subset U\) be compact, and let \(\varphi_n(z)=f_n(z)-f(z)\). By \autoref{thm:cauchysestimate}, \(\abs{\varphi'(z)}\)
\end{proof}
