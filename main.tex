...
In other words, \(\forall B_1,B_2\in\mathcal{B}\), \(\forall x\in B_1\cap B_2\), \(\exists B_3\in\mathcal{B}\) such that \(x\in B_3\) and \(B_3\subseteq B_1\cap B_2\). From now on when we refer to a set, it will refer to the topological space of the set under the standard topology.
\begin{lemma}
    Let \(\Omega\subseteq\mathbb{C}\)
\end{lemma}
