...
\begin{proof}
    ...
    \[k_g-k_f=\int_{\gamma}\frac{g'(z)}{g(z)}\ddz-\int_\gamma\frac{f'(z)}{f(z)}\ddz=\int_\gamma\mfrac{g'(z)f(z)-f'(z)g(z)}{g(z)f(z)}\ddz=\int_\gamma\frac{\paren{\mfrac{g(z)}{f(z)}}'}{\frac{g(z)}{f(z)}}\ddz.\]
