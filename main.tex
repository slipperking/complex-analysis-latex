...
\begin{theorem}[Abel's Theorem]\label{thm:abelradius}
    ...
    \begin{enumerate}
        \item \(S(z)\) absolutely converges on \(\abs{z}<R\), and \(\forall 0\leq\rho<R\), uniformly converges on \(\abs{z}\leq\rho\).\label{itm:abelradius_absoluteanduniformconvergence}
