...
\begin{proof}
    ...
    To prove the converse statement, let \(\mathcal{U}\) be an arbitrary open cover of \(X\). By the assumption that \(X\) is bounded, \(\exists R>0\) such that \[X\subseteq\left\{z\;\middle|z\in\mathbb{C}^n, \;\right\}\]
\end{proof}
