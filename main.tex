...
\end{proof}
\subsubsection{Holomorphic Automorphism Groups}
...
Let \(a\in D(0,1)\) and notice that \(\varphi_a(z)=\frac{z-a}{1-\overline{a}z}\in\Aut(D(0,1))\) maps \(\partial D\) to \(\partial D\) bijectively. Let \(\Phi:D(0,1)\to\mathbb{R}\) be harmonic such that \(\Phi\) is continuous on \(\overline{D(0,1)}\). By the mean-value property introduced in \autoref{lemma:holomorphicmeanvalueproperty}, we have \[\Phi (0)=\frac{1}{2\pi\rho}\int_0^{2\pi}\Phi\qty(\rho e^{i\theta})\dd{\theta},\]
...
\end{equation}
Let \(u(z)=\Phi\circ\varphi_a(z)\), which is also harmonic on \(D(0,1)\). By the univalence of \(\varphi_a\), let \(e^{i\theta}=\varphi_a\qty(e^{i\tau})\). It follows that \[ie^{i\theta}\dd{\theta}=i\frac{1-\overline{a}a}{(1-\overline{a}e^{i\tau})^2}e^{i\tau}\dd{\tau}\Longleftrightarrow\dd{\theta}=\frac{1-\overline{a}a}{(1-\overline{a}e^{i\tau})^2}\frac{1-\overline{a}e^{i\tau}}{e^{i\tau}-a}e^{i\tau}\dd{\tau}=\frac{1-\abs{a}^2}{\abs{1-\overline{a}e^{i\tau}}^2}\dd{\tau}.\]
Then from equation \eqref{eq:harmonicfunctionmeanvalueoverboundaryofunitdisk}, since \(\Phi(0)=u\circ\varphi_{-a}(0)=u(a)\), \[\Phi(0)=\frac{1}{2\pi}\int_0^{2\pi}u\qty( e^{i\tau})\frac{1-\abs{a}^2}{\abs{1-\overline{a}e^{i\tau}}^2}\dd{\tau}=u(a).\]
...
\(\forall a\in D(0,R)\), \(\forall R>0\), we can apply the transformation \(\tilde{\varphi}_a\qty(z)=R\varphi_{\flatfrac{a}{R}}\qty(\frac{z}{R})\) to extend the automorphism to \(D(0,R)\). Let \(\Phi\) instead be harmonic on \(D(0,R)\) and continuous on \(\overline{D(0,R)}\). Then, \[\Phi(0)=\frac{1}{2\pi}\int_0^{2\pi}\Phi\qty(Re^{i\theta})\dd{\theta}.\] It follows that \(u=\Phi\circ\tilde{\varphi}_a\) is also harmonic on \(D(0,R)\) with \(\Phi(0)=u\circ\tilde{\varphi}_{-a}(0)=u(a)\), and from the bijectivity of  \(Re^{i\theta}=\tilde{\varphi}_a\qty(Re^{i\tau})\), 
\[\dd{\theta}=\frac{1-\frac{\abs{a}^2}{R^2}}{\paren{1-\frac{\overline{a}}{R}e^{i\tau}}^2}e^{i\tau}e^{-i\theta}\dd{\tau}=\dd{\theta}=\frac{1-\frac{\abs{a}^2}{R^2}}{\paren{1-\frac{\overline{a}}{R}e^{i\tau}}^2}\frac{1-\frac{\overline{a}}{R}e^{i\tau}}{1-\frac{a}{R}e^{-i\tau}}\dd{\tau}=\frac{R^2-\abs{a}^2}{\abs{Re^{i\tau}-a}^2}\dd{\tau}.\]
Then because \(\tilde{\varphi}_a^{-1}(z)=R\varphi_{-\flatfrac{a}{R}}\qty(\frac{z}{R})\), 
