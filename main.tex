...
\[f(z)=\int_{\partial U}f(\zeta)H(\zeta,z)\ddzeta.\] There also exist other integral formulae for holomorphic functions, varying in the kernel of the expression.
...
Then from equation \eqref{eq:harmonicfunctionmeanvalueoverboundaryofunitdisk}, \[\Phi(0)=\frac{1}{2\pi}\int_0^{2\pi}\Phi\circ \varphi_a\qty( e^{i\tau})\dd{\theta}\]
