...
\begin{proof}
    \begin{figure}
        ...
        \begin{tikzpicture}[>=stealth,
            ...
            \pgfmathsetmacro{\eta}{15pt}

            \coordinate (M) at (1, 1);
            \coordinate (P) at (1, 3.5);
            \coordinate (Q) at (5, 4);
            \coordinate (N) at (5, 1.5);
            ...
            \draw[thick, arrow style] (Mprime) to[out angle=270, in angle=270, curve through = {([shift={(-2, 0)}] Nprime) ([shift={(-1.5, -0.2)}] Nprime)}] (Nprime);
