...
\begin{proof}
    ...
    By the continuity of \(f\), \(\exists\lambda>0\) such that \(\forall0<\varepsilon<\lambda\), \(\forall z\in\gamma\), \(\abs{f(z)}>\varepsilon\). By the uniform convergence of \(\cbraces{f_n(z)}\) and \(\cbraces{f'_n(z)}\), \(\exists N\in\mathbb{N}\) such that
    \[\abs{f_n(z)-f(z)}<\frac{\varepsilon^3}{2},\quad\abs{f'_n(z)-f'(z)}<\frac{\varepsilon^3}{2},\quad\forall n>N,\forall z\in\gamma.\]
    Then \(\abs{f_n(z)}>\varepsilon-\frac{\varepsilon^3}{2}\) on \(\gamma\). It follows that \(\frac{1}{f_n(z)}\) and its limit are uniformly bounded: \[\abs{\frac{1}{f(z)}}<\frac{1}{\varepsilon},\quad\abs{\frac{1}{f_n(z)}}<\frac{2}{\varepsilon},\quad\forall z\in\gamma,\forall n>N.\]
    Then,
    \begin{align*}
        \abs{\frac{f'}{f}-\frac{f'_n}{f_n}}&=\abs{\frac{f'f_n-f'_nf}{f_nf}}\\
        &<2\frac{\abs{f'f_n-f'f}+\abs{f'f-f'_nf}}{\varepsilon^2}\\
        &<\frac{2M}{\varepsilon^2}\cdot\paren{\abs{f_n-f}+\abs{f'-f'_n}}\\
        &<2M\varepsilon.
    \end{align*}
