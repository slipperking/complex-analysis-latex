...
\begin{proof}
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \draw[thick] (M) -- (P);
            \draw[thick] (P) to[out angle=90, in angle=90, curve through = {([shift={(1, 0.2)}] P) ([shift={(2, 0)}] P)}] (Q);
            \draw[thick] (Q) -- (N);
            \draw[thick] (N) to[out angle=270, in angle=270, curve through = {([shift={(-1, -0.2)}] N) ([shift={(-2, 0)}] N)}] (M);
        \end{tikzpicture}
        \caption{}
