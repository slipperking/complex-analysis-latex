...
We will first formally state 

First we will introduce the Weierstrass' Theorem for the uniform convergence of the derivatives of a holomorphic function sequence.
