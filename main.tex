...
Because \(\psi(\zeta)\) is compactly supported and continuous, by \ref{thm:continuousfunctionbounded}, it is bounded. Bisect \(\mathbb{C}\) into \(\mathbb{C}\setminus D\paren{z,\varepsilon}\) and \(D\paren{z,\varepsilon}\). 
\end{document}
