...
\end{enumerate}
\begin{remark}
    The term \textit{neighborhood of \(\infty\)} refers to a set in the form of \(\mathbb{C}\setminus K\), where \(K\) is compact and connected. Take a neighborhood of \(\mqty(0\\0\\1)\) of \(S_2\), and 
\end{remark}
\begin{example}
