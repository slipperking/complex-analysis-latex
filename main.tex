...
\begin{proof}
    ...
    \end{cases}.\]
    We can define the function \[\varphi_\varepsilon(x)=\frac{1}{2\varepsilon+1}\begin{cases}
        \phi\paren{1+\varepsilon-\abs{x}}&\abs{x}\ge\varepsilon\\
        1&\abs{x}<\varepsilon
    \end{cases},\]
    which satisfies \(\forall\varepsilon>0\), \[\int_{-\infty}^\infty \varphi_\varepsilon(x)\ddx=1,\] \(\varphi_\varepsilon\in C^\infty(\mathbb{R})\) and \(\supp\paren{\varphi_\varepsilon}\) is compact. We can extend this to \(\varphi_\varepsilon:\mathbb{C}\to\mathbb{R}\) with \[\varphi_\varepsilon(z)=\frac{1}{2\varepsilon+1}\begin{cases}
