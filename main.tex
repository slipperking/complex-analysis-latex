...
\begin{proof}
    ...
    \begin{align*}
        \residue_{z=i}\frac{1}{\qty(z^2+1)^{n+1}} & =\left.\frac{1}{n!}\dv[n]{z}((z+i)^{-n-1})\right|_{z=i}=\frac{1}{n!}\frac{(-1)^n\prod_{k=1}^n (n+k)}{(2i)^{2n+1}} \\
...
\end{example}
\begin{proof}
    This is a standard integral that can be evaluated using polar coordinates. However, we will now provide a solution via contour integration. Let \(\gamma\) be a closed semicircle as in \autoref{fig:semicircularcontour}, with radius \(R\geq 2\). 
\end{proof}
