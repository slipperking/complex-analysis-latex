...
\begin{proof}
    ...
    have that \[\mathrm{I}=\frac\uppi4\operatorname{sgn}(x+2\lambda),\qquad\mathrm{I\!I}=\frac\uppi4\operatorname{sgn}(x-2\lambda).\] Similarly, \(\mathrm{I\!I\!I}=\frac\uppi2\operatorname{sgn}(x)\). Hence, \[\dv{I}{x}=\frac\uppi4\qty[\operatorname{sgn}(x+2\lambda)+\operatorname{sgn}(x-2\lambda)-2\operatorname{sgn}(x)],\] and \[I(0)+\int_0^x\dv{I}{x}\ddx=I(0)+
        \begin{dcases}
            \frac\uppi 4\qty[\eval{-x-x+2x}_{-2\lambda}^x]+I\qty(-2\lambda^+)-I(0) & x<-2\lambda,   \\
            \frac\uppi 4(x-x+2x)=\frac{\uppi x}{2}                                 & -2\lambda<x<0, \\
            \frac\uppi 4(x-x-2x)=-\frac{\uppi x}{2}                                & 0<x<2\lambda,  \\
            \frac\uppi 4\qty[\eval{x+x-2x}_{2\lambda}^x]+I\qty(2\lambda^-)-I(0)    & x>2\lambda,
...
\begin{proof}
    ...
    \begin{enumerate}
        \item \(f(x_n)-L>\varepsilon\) for all \(n\in\mathbb{N}\). By the slow decrease of \(f\), there exist \(\delta>0\) and \(N\in\mathbb{N}\) such that \[f(y)>f\qty(x_n)-\frac{\varepsilon}{2}>L+\frac\varepsilon2\] for any \(n>N\) and \(0<y-x_n<2\delta\). Then we have
            ...
            Letting \(\lambda\to\infty\), we have \[\frac{2L+\varepsilon}{2\uppi}\int_{-\delta\lambda}^{\delta\lambda}\qty(\frac{\sin t}{t})^2\ddt-\frac{2M}{\uppi}\int_{\delta\lambda}^\infty\qty(\frac{\sin t}{t})^2\ddt\to\frac{2L+\varepsilon}{2\uppi}\int_{\mathbb{R}}\qty(\frac{\sin t}{t})^2\ddt=L+\frac{\varepsilon}{2}.\]
