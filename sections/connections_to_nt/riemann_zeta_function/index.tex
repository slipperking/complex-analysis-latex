...
\begin{proof}
    ...
    \end{enumerate}
    We have thus shown that \(\abs{\ee^z-1}\) is bounded below by a positive constant \[\min\cbraces{1-\ee^{-2},\frac2{\ee}\cos(\frac2\uppi)}>0\] for all \(z\in\bigsqcup_{n=1}^\infty\partial D\qty(0,(2n+1)\uppi)\) (and hence
