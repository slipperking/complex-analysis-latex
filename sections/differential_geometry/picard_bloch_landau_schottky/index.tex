...
\end{theorem}
\begin{proof}
    Consider conformal map \(\zeta_1(w):\mathbb{C}\setminus(0,1)\to\mathbb{C}\setminus\mathbb{D}\), \(\zeta_1(\infty)=1\), \(\zeta_1(1)=1\), \(\zeta_1(0)=-1\). Explicitly, we have the relationship \[\zeta_1+\frac1{\zeta_1}=4w-2\] as an affine transformation of the inverse \textit{Joukowski transform} (\(z\mapsto z+z^{-1}\)). 
\end{proof}
