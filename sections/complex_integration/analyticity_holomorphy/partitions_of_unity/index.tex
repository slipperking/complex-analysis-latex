...
\begin{definition}
    For a topological space \(X\), a set \(A\subseteq X\) is compact iff every open cover has a finite subcover.
\end{definition}
\begin{definition}
...
\end{definition}
For the case of metric spaces, this generalizes the \(\varepsilon\)--\(\delta\) notion of continuity.
\begin{example}
