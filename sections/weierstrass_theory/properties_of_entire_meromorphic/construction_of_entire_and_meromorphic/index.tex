...
\begin{proof}
    ...
    \end{align}
    Since \[\abs{f}<\max\cbraces{M,\csch[2](\piup)+\frac{1}{3}+\frac{2}{\piup^2}}\] on \(\mathbb{C}\), Liouville's Theorem (\cref{thm:liouville}) gives that \(f\) is constant. At \(z=\frac{1}{2}\), we have
    \begin{align*}
