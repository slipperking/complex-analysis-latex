...
\end{definition}
The conclusion of \cref{thm:entirefunctionfiniteorderzerossummationconvergence}, the rank of an entire function with finite order exists. Moreover, the rank \(\leq\floor{\rho}\).
