...
\begin{proof}
    ...
    \begin{enumerate}
        \item Assume \(R_0=\infty\). Then define \(r'_0=r_0\), and \[r_1=\inf\cbraces{r>r'_0}{\text{\cref{eq:nevanlinnaborel_infiniteradius} fails}},\quad r'_1=r_1+\flatfrac1{T\qty(r_1)}>r_1,\]
            ...
            Using induction, \(T(r_n)\geq 2^nT\qty(r_0)\), implying that \[r'_n-r_n=\frac1{T(r_n)}\leq\frac1{2^nT\qty(r_0)}\implies\sum_{n=0}^\infty\qty(r'_n-r_n)=\frac1{T(r_0)}\sum_{n=0}^\infty\frac1{2^n}=\frac2{T\qty(r_0)}\leq2.\]
        \item Suppose \(R_0<\infty\) in the theorem statement.
    \end{enumerate}
\end{proof}
