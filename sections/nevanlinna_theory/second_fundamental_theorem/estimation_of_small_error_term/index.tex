...
\begin{proof}
    ...
    and let \(E=\textstyle\bigcup_{\nu=1}^n E_\nu\). For \(\theta\in E\), \(\delta\qty(r\ee^{\ii\theta})<\flatfrac{r}{n}\), implying that \(\frac{r}{\delta\qty(r\ee^{\ii\theta})}>n\). Define \[\log_0x=\begin{cases}
        \log x&x\geq n,\\
        0&\text{otherwise},
    \end{cases},\]
    so that for \(\theta\) in the prescribed range, we have \[\]
    Since \(0<\flatfrac1n\leq1\),
\end{proof}
