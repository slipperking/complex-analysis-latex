...
\begin{proof}
    ...
    Lastly, assume that \(R_0<\infty\). Now apply \cref{prop:nevanlinnalogdiffproximityestimate} with \(R=r+\frac{R_0-r}{\ee T(r,f)}\), then outside an exceptional set satisfying
\end{proof}
