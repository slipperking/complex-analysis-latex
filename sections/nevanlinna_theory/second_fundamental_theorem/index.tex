...
\begin{proof}
    ...
    \begin{equation}
        m(r,F)\geq\sum_{\nu=1}^qm\qty(r,a_\nu,f)-q\log^+\frac{3q}\delta-\log 2.\label{eq:nevanlinnasecondfundamentaltheorem_proximityFlowerbound}
    \end{equation}
