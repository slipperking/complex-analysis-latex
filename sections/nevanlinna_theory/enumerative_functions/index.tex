...
\end{proof}
\begin{definition}
    For \(r>0\), \(a\in\mathbb{C}\), define the \textit{Nevanlinna Characteristic} by \[m(r,a,f)=\frac1{2\uppi}\int_0^{2\uppi}\log^+\abs{\frac1{f\qty(r\ee^{\ii\theta})-a}}\dd{\theta}\] and \[m(r,\infty,f)=\frac1{2\uppi}\int_0^{2\uppi}\log^+\abs{f\qty(r\ee^{\ii\theta})}\dd{\theta}\] in the infinite case. Observe that \(m(r,a,f)=m\qty(r,\infty,\frac1{f-a})\) (for simplicity, we may also omit the argument \(a\) to imply \(\infty\)).
\end{definition}
