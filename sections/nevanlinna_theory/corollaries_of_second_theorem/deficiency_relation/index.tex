...
\end{theorem}
\begin{remark}
    The geometric analog of the second fundamental theorem suggests that the value two is related to the Euler characteristic of the Riemann sphere via triangulation.
\end{remark}
