...
For \(w=f(z)\), pulling back to \(z\) gives \[A(r)=\frac1{\uppi}\iint_{\symbf{\sigma}(f\qty(D(0,r)))}\dd{A},\] or the area of the image of \(f\) on the Riemann sphere, counted according to multiplicities (referring to overlaps when not univalent), divided by the area of the Riemann sphere.
