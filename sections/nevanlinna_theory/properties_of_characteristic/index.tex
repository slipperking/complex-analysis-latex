...
\begin{theorem}\label{thm:nevanlinnacartanidentity}
    ...
    \begin{align*}
        ...
        \begin{cases}
            ...
            0&\qif*k>0,
        \end{cases}
    \end{align*} where \(c_\theta\) is the first nonzero coefficient of the Laurent expansion of \(f-\ee^{\ii\theta}\) at the origin.
\end{theorem}
\begin{proof}
    ...
    \end{cases}\qedhere\]
\end{proof}
\begin{theorem}\label{thm:nevanlinnacharacteristicnondecreasingconvex}
    For (non-constant) meromorphic \(f\) in \(D(0,R)\), \(T(r,f)\) is a nondecreasing convex (not necessarily strictly convex) function of \(\log r\) (\(0<r<R\)).
\end{theorem}
\begin{proof}
    ...
    \begin{align*}
        ...
        &=\frac1{2\uppi}\int_0^{2\uppi}n\qty(r,\ee^{\ii\theta},f)\dd{\theta}\geq0
    \end{align*}
