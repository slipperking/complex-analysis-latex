...
\begin{proof}[Proof of equivalent definitions]
    ...
    Assume there exists some \(\varepsilon>0\) such that \[T(r,f)=\order{r^{\rho-\varepsilon}}.\] Then there exist finite \(c,r'\) such that \(\forall r>r'\), \[T(r,f)\leq cr^{\rho-\varepsilon}\implies\logp T(r,f)\leq\order{1}+\qty(\rho-\varepsilon)\log r\implies\frac{\logp T(r,f)}{\log r}\leq\rho-\varepsilon,\]
