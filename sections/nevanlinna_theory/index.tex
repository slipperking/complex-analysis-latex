...
The information we present here is primarily based on~\cite{holland1973introduction} and some structural remarks of~\cite{charak2009meromorphicvaluedistribution}.
...
The L. V. Ahlfors has also discovered a geometric theory that in general reflects the many concepts in Nevanlinna Theory in a geometric way (including the first and second fundamental theorems) via covering surfaces. This viewpoint will not be discussed here, although it is covered with sufficient detail in \cite{hayman1964meromorphic}.
