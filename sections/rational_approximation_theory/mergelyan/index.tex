...
\begin{proof}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \draw[thin, |-|, line cap=round, shorten >=1pt] (1.97,-1.16) -- (1.93,-0.78) node[midway, anchor=east] {\small\(r\)};
            \draw[thin, |-|, line cap=round, shorten >=1pt] (-0.41,0.05) -- (-0.18,0.36) node[midway, anchor=north west] {\small\(r\)};
